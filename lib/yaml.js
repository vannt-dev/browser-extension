const mt = Symbol.for("yaml.alias"), ct = Symbol.for("yaml.document"), W = Symbol.for("yaml.map"), Ut = Symbol.for("yaml.pair"), V = Symbol.for("yaml.scalar"), de = Symbol.for("yaml.seq"), j = Symbol.for("yaml.node.type"), ee = (s) => !!s && typeof s == "object" && s[j] === mt, te = (s) => !!s && typeof s == "object" && s[j] === ct, pe = (s) => !!s && typeof s == "object" && s[j] === W, L = (s) => !!s && typeof s == "object" && s[j] === Ut, T = (s) => !!s && typeof s == "object" && s[j] === V, me = (s) => !!s && typeof s == "object" && s[j] === de;
function $(s) {
...
const Ft = (s) => (T(s) || $(s)) && !!s.anchor, M = Symbol("break visit"), Vt = Symbol("skip children"), F = Symbol("remove node");
function se(s, e) {
  const t = Jt(e);
  te(s) ? re(null, s.contents, t, Object.freeze([s])) === F && (s.contents = null) : re(null, s, t, Object.freeze([]));
}
se.BREAK = M;
se.SKIP = Vt;
se.REMOVE = F;
...
async function Fe(s, e) {
  const t = Jt(e);
  te(s) ? await oe(null, s.contents, t, Object.freeze([s])) === F && (s.contents = null) : await oe(null, s, t, Object.freeze([]));
}
Fe.BREAK = M;
Fe.SKIP = Vt;
Fe.REMOVE = F;
...
function Ds(s, e) {
  ...
  return {
    ...
    setAnchors: () => {
      for (const r of t) {
        const o = n.get(r);
        if (typeof o == "object" && o.anchor && (T(o.node) || $(o.node)))
...
class Ve extends yt {
  ...
  resolve(e, t) {
    ...
    let n;
    t != null && t.aliasResolveCache ? n = t.aliasResolveCache : (n = [], se(e, {
      Node: (r, o) => {
        (ee(o) || Ft(o)) && n.push(o);
      }
  ...
  toJSON(e, t) {
    ...
    let l = n.get(o);
    if (l || (P(o, null, t), l = n.get(o)), (l == null ? void 0 : l.res) === void 0) {
...
function Ne(s, e, t) {
  var f, d, h;
  if (te(s) && (s = s.contents), _(s))
    return s;
  if (L(s)) {
    const y = (d = (f = t.schema[W]).createNode) == null ? void 0 : d.call(f, t.schema, null, t);
  ...
  if (n && s && typeof s == "object") {
    if (a = l.get(s), a)
      return a.anchor ?? (a.anchor = i(s)), new Ve(a.anchor);
    a = { anchor: null, node: null }, l.set(s, a);
  }
  e != null && e.startsWith("!!") && (e = qs + e.slice(2));
  let c = Rs(s, e, o.tags);
  if (!c) {
...
class zt extends yt {
  ...
  clone(e) {
    ...
    return e && (t.schema = e), t.items = t.items.map((n) => _(n) || L(n) ? n.clone(e) : n), this.range && (t.range = this.range.slice()), t;
  }
  /**
  ...
  getIn(e, t) {
    const [n, ...i] = e, r = this.get(n, !0);
    return i.length === 0 ? !t && T(r) ? r.value : r : $(r) ? r.getIn(i, t) : void 0;
  }
  hasAllNullValues(e) {
...
`) ? Y(t, e) : t.includes(`
`) ? `
` + Y(t, e) : (s.endsWith(" ") ? "" : " ") + t, Zt = "flow", ft = "block", Me = "quoted";
function Je(s, e, t = "flow", { indentAtStart: n, lineWidth: i = 80, minContentWidth: r = 20, onFold: o, onOverflow: l } = {}) {
  if (!i || i < 0)
    return s;
  i < r && (r = 0);
  ...
  let d, h, y = !1, u = -1, m = -1, g = -1;
  t === ft && (u = Ct(s, u, e.length), u !== -1 && (f = u + a));
  for (let k; k = s[u += 1]; ) {
    if (t === Me && k === "\\") {
      switch (m = u, s[u + 1]) {
        case "x":
    ...
    if (k === `
`)
      t === ft && (u = Ct(s, u, e.length)), f = u + e.length + a, d = void 0;
    else {
      if (k === " " && h && h !== " " && h !== `
` && h !== "	") {
        const S = s[u + 1];
...
`, a += 2;
  ...
  return o = l ? o + t.slice(l) : t, n ? o : Je(o, r, Me, Ye(e, !1));
}
function ut(s, e) {
...
${t}`) + "'";
  return e.implicitKey ? n : Je(n, t, Zt, Ye(e, !1));
}
function ae(s, e) {
...
function Ke({ comment: s, type: e, value: t }, n, i, r) {
  ...
  if (!o || /\n[\t ]+$/.test(t))
    return ae(t, n);
  const c = n.indent || (n.forceBlockIndent || Ge(t) ? "  " : ""), p = o === "literal" ? !0 : o === "folded" || e === O.BLOCK_FOLDED ? !1 : e === O.BLOCK_LITERAL ? !0 : !Fs(t, a, c.length);
  if (!t)
    return p ? `|
` : `>
`;
...
` && (h = h.slice(0, -1)), h = h.replace(ht, `$&${c}`));
  let u = !1, m, g = -1;
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g, "$1$2").replace(/\n+/g, `$&${c}`);
    let E = !1;
    const A = Ye(n, !0);
    o !== "folded" && e !== O.BLOCK_FOLDED && (A.onOverflow = () => {
      E = !0;
    });
    const w = Je(`${b}${N}${h}`, c, ft, A);
    if (!E)
      return `>${S}
${c}${w}`;
  }
...
function ue(s, e, t, n) {
  ...
  const l = typeof i.stringify == "function" ? i.stringify(r, e, t, n) : T(r) ? Ee(r, e, t, n) : r.toString(e, t, n);
  return o ? T(r) || l[0] === "{" || l[0] === "[" ? `${o} ${l}` : `${o}
${e.indent}${l}` : l;
}
function Gs({ key: s, value: e }, t, n, i) {
  ...
  if (f) {
    ...
    if ($(s) || !_(s) && typeof s == "object") {
      const A = "With simple keys, collection cannot be used as a key value";
      throw new Error(A);
    }
  }
  let h = !f && (!s || d && e == null && !t.inFlow || $(s) || (T(s) ? s.type === O.BLOCK_FOLDED || s.type === O.BLOCK_LITERAL : typeof s == "object"));
  t = Object.assign({}, t, {
    allNullValues: !1,
    implicitKey: !h && (f || !r),
    indent: l + a
  });
  let y = !1, u = !1, m = ue(s, t, () => y = !0, () => u = !0);
  ...
  if (t.inFlow) {
    ...
    return m = `? ${m}`, d && !y ? m += X(m, t.indent, c(d)) : u && i && i(), m;
  y && (d = null), h ? (d && (m += X(m, t.indent, c(d))), m = `? ${m}
${l}:`) : (m = `${m}:`, d && (m += X(m, t.indent, c(d))));
  let g, b, k;
  _(e) ? (g = !!e.spaceBefore, b = e.commentBefore, k = e.comment) : (g = !1, b = null, k = null, e && typeof e == "object" && (e = o.createNode(e))), t.implicitKey = !1, !h && !d && T(e) && (t.indentAtStart = m.length + 1), u = !1, !p && a.length >= 2 && !t.inFlow && !h && me(e) && !e.flow && !e.tag && !e.anchor && (t.indent = t.indent.substring(2));
  let S = !1;
  const N = ue(e, t, () => S = !0, () => u = !0);
  let E = " ";
  if (d || g || b) {
    if (E = g ? `
` : "", b) {
...
`), I = w !== -1, v = t.inFlow ?? e.flow ?? e.items.length === 0;
    if (I || !v) {
      let J = !1;
      if (I && (A === "&" || A === "!")) {
        let D = N.indexOf(" ");
        A === "&" && D !== -1 && D < w && N[D + 1] === "!" && (D = N.indexOf(" ", D + 1)), (D === -1 || w < D) && (J = !0);
      }
      J || (E = `
${t.indent}`);
    }
...
`) && (E = "");
  return m += E + N, t.inFlow ? S && n && n() : k && !S ? m += X(m, t.indent, c(k)) : u && i && i(), m;
}
function es(s, e) {
...
const Le = "<<", G = {
  ...
  test: /^<<$/,
  resolve: () => Object.assign(new O(Symbol(Le)), {
    addToJSMap: ts
  }),
  stringify: () => Le
}, Qs = (s, e) => (G.identify(e) || T(e) && (!e.type || e.type === O.PLAIN) && G.identify(e.value)) && (s == null ? void 0 : s.doc.schema.tags.some((t) => t.tag === G.tag && t.default));
function ts(s, e, t) {
  const n = ss(s, t);
  if (me(n))
...
function ss(s, e) {
  return s && ee(e) ? e.resolve(s.doc, s) : e;
}
...
class C {
  constructor(e, t = null) {
    Object.defineProperty(this, j, { value: Ut }), this.key = e, this.value = t;
  }
  clone(e) {
    let { key: t, value: n } = this;
    return _(t) && (t = t.clone(e)), _(n) && (n = n.clone(e)), new C(t, n);
  }
  toJSON(e, t) {
  ...
  toString(e, t, n) {
    return e != null && e.doc ? Gs(this, e, t, n) : JSON.stringify(this);
  }
}
function is(s, e, t) {
  return (e.inFlow ?? s.flow ? Xs : Hs)(s, e, t);
}
function Hs({ comment: s, items: e }, t, { blockItemPrefix: n, flowChars: i, itemIndent: r, onChompKeep: o, onComment: l }) {
  ...
  for (let y = 0; y < e.length; ++y) {
    ...
    if (_(u))
      ...
      const b = _(u.key) ? u.key : null;
      b && (!f && b.spaceBefore && d.push(""), De(t, d, b.commentBefore, f));
    }
    f = !1;
    let g = ue(u, p, () => m = null, () => f = !0);
    m && (g += X(g, r, c(m))), f && m && (f = !1), d.push(n + g);
  }
  let h;
  if (d.length === 0)
    h = i.start + i.end;
...
function Xs({ items: s }, e, { flowChars: t, itemIndent: n }) {
  ...
  for (let y = 0; y < s.length; ++y) {
    ...
    if (_(u))
      ...
      const b = _(u.key) ? u.key : null;
      b && (b.spaceBefore && f.push(""), De(e, f, b.commentBefore, !1), b.comment && (c = !0));
      const k = _(u.value) ? u.value : null;
      k ? (k.comment && (m = k.comment), k.commentBefore && (c = !0)) : u.value == null && (b != null && b.comment) && (m = b.comment);
    }
    m && (c = !0);
    let g = ue(u, a, () => m = null);
    c || (c = f.length > p || g.includes(`
`)), y < s.length - 1 ? g += "," : e.options.trailingComma && (e.options.lineWidth > 0 && (c || (c = f.reduce((b, k) => b + k.length + 2, 2) + (g.length + 2) > e.options.lineWidth)), c && (g += ",")), m && (g += X(g, n, l(m))), f.push(g), p = f.length;
  }
...
class K extends zt {
  ...
  add(e, t) {
    var o;
    let n;
    L(e) ? n = e : !e || typeof e != "object" || !("key" in e) ? n = new C(e, e == null ? void 0 : e.value) : n = new C(e.key, e.value);
    const i = z(this.items, n.key), r = (o = this.schema) == null ? void 0 : o.sortMapEntries;
    if (i) {
      if (!t)
        throw new Error(`Key ${n.key} already set`);
      T(i.value) && Xt(n.value) ? i.value.value = n.value : i.value = n.value;
    } else if (r) {
  ...
  toString(e, t, n) {
    ...
    return !e.allNullValues && this.hasAllNullValues(!1) && (e = Object.assign({}, e, { allNullValues: !0 })), is(this, e, {
      blockItemPrefix: "",
      flowChars: { start: "{", end: "}" },
      itemIndent: e.indent || "",
      onChompKeep: n,
...
class H extends zt {
  ...
  set(e, t) {
    ...
    const i = this.items[n];
    T(i) && Xt(t) ? i.value = t : this.items[n] = t;
  }
  toJSON(e, t) {
    const n = [];
...
const _e = ({ value: s }) => JSON.stringify(s), Zs = [
  {
    identify: (s) => typeof s == "string",
    default: !0,
    tag: "tag:yaml.org,2002:str",
    ...
    for (let t = 0; t < s.items.length; ++t) {
      ...
      if (!L(n)) {
        if (pe(n)) {
          ...
          const i = n.items[0] || new C(new O(null));
...
function ps({ value: s, source: e }, t) {
  return e && (s ? ms : ys).test.test(e) ? e : s ? t.options.trueStr : t.options.falseStr;
}
const ms = {
  identify: (s) => s === !0,
  default: !0,
...
class fe extends K {
  ...
  add(e) {
    let t;
    L(e) ? t = e : e && typeof e == "object" && "key" in e && "value" in e && e.value === null ? t = new C(e.key, null) : t = new C(e, null), z(this.items, t.key) || this.items.push(t);
  }
  /**
  ...
  set(e, t) {
    ...
    const n = z(this.items, e);
    n && !t ? this.items.splice(this.items.indexOf(n), 1) : !n && t && this.items.push(new C(e));
  }
  toJSON(e, t) {
...
function nt(s, e, t) {
  ...
  if (!i)
    if (Array.isArray(s))
      ...
      const r = Array.from(Mt.keys()).filter((o) => o !== "yaml11").map((o) => JSON.stringify(o)).join(", ");
  ...
  return t && (i = i.concat(G)), i.reduce((r, o) => {
    const l = typeof o == "string" ? Kt[o] : o;
    if (!l) {
      const a = JSON.stringify(o), c = Object.keys(Kt).map((p) => JSON.stringify(p)).join(", ");
...
class Ze {
  constructor({ compat: e, customTags: t, merge: n, resolveKnownTags: i, schema: r, sortMapEntries: o, toStringDefaults: l }) {
    this.compat = Array.isArray(e) ? nt(e, "compat") : e ? nt(null, e) : null, this.name = typeof r == "string" && r || "core", this.knownTags = i ? cn : {}, this.tags = nt(t, this.name, n), this.toStringOptions = l ?? null, Object.defineProperty(this, W, { value: ye }), Object.defineProperty(this, V, { value: Qe }), Object.defineProperty(this, de, { value: ge }), this.sortMapEntries = typeof o == "function" ? o : o === !0 ? fn : null;
  }
  clone() {
...
function un(s, e) {
  ...
  if (s.contents) {
    ...
    let p = ue(s.contents, i, () => l = null, c);
    l && (p += X(p, "", r(l))), (p[0] === "|" || p[0] === ">") && t[t.length - 1] === "---" ? t[t.length - 1] = `--- ${p}` : t.push(p);
  } else
...
`) ? (t.push("..."), t.push(Y(c, ""))) : t.push(`... ${c}`);
    ...
    let c = s.comment;
    c && o && (c = c.replace(/^\n+/, "")), c && ((!o || l) && t[t.length - 1] !== "" && t.push(""), t.push(Y(r(c), "")));
  }
  return t.join(`
`) + `
`;
...
class be {
  constructor(e, t, n) {
    this.commentBefore = null, this.comment = null, this.errors = [], this.warnings = [], Object.defineProperty(this, j, { value: ct });
    let i = null;
  ...
  createNode(e, t, n) {
    ...
    if (typeof t == "function")
      ...
      const m = (b) => typeof b == "number" || b instanceof String || b instanceof Number, g = t.filter(m).map(String);
      g.length > 0 && (t = t.concat(g)), i = t;
    } else n === void 0 && t && (n = t, t = void 0);
    const { aliasDuplicateObjects: r, anchorPrefix: o, flow: l, keepUndefined: a, onTagObj: c, tag: p } = n ?? {}, { onAnchor: f, setAnchors: d, sourceObjects: h } = Ds(
      this,
   ...
   */
  deleteIn(e) {
    return Se(e) ? this.contents == null ? !1 : (this.contents = null, !0) : ne(this.contents) ? this.contents.deleteIn(e) : !1;
  }
  /**
   * Returns item at `key`, or `undefined` if not found. By default unwraps
   * scalar values from their surrounding node; to disable set `keepScalar` to
   ...
   */
  get(e, t) {
    return $(this.contents) ? this.contents.get(e, t) : void 0;
  }
  /**
   ...
   */
  getIn(e, t) {
    return Se(e) ? !t && T(this.contents) ? this.contents.value : this.contents : $(this.contents) ? this.contents.getIn(e, t) : void 0;
  }
  /**
   * Checks if the document includes a value with the key `key`.
   */
  has(e) {
    return $(this.contents) ? this.contents.has(e) : !1;
  }
  /**
   * Checks if the document includes a value at `path`.
   */
  hasIn(e) {
    return Se(e) ? this.contents !== void 0 : $(this.contents) ? this.contents.hasIn(e) : !1;
  }
  /**
   ...
   */
  setIn(e, t) {
    Se(e) ? this.contents = t : this.contents == null ? this.contents = je(this.schema, Array.from(e), t) : ne(this.contents) && this.contents.setIn(e, t);
  }
  /**
...
`), o = l + o;
  ...
  if (/[^ ]/.test(o)) {
    let l = 1;
    const a = t.linePos[1];
    (a == null ? void 0 : a.line) === n && a.col > i && (l = Math.max(1, Math.min(a.col - i, 80 - r)));
...
function he(s, { flow: e, indicator: t, next: n, offset: i, onError: r, parentIndent: o, startOnNewline: l }) {
  let a = !1, c = l, p = l, f = "", d = "", h = !1, y = !1, u = null, m = null, g = null, b = null, k = null, S = null, N = null;
  for (const w of s)
    switch (y && (w.type !== "space" && w.type !== "newline" && w.type !== "comma" && r(w.offset, "MISSING_CHAR", "Tags and anchors must be separated from the next token by white space"), y = !1), u && (c && w.type !== "comment" && w.type !== "newline" && r(u, "TAB_AS_INDENT", "Tabs are not allowed as indentation"), u = null), w.type) {
      ...
      case "comment": {
        ...
        const I = w.source.substring(1) || " ";
        f ? f += d + I : f = I, d = "", c = !1;
        break;
      }
      case "newline":
        c ? f ? f += w.source : (!S || t !== "seq-item-ind") && (a = !0) : d += w.source, c = !0, h = !0, (m || g) && (b = w), p = !0;
        break;
      case "anchor":
        m && r(w, "MULTIPLE_ANCHORS", "A node can have at most one anchor"), w.source.endsWith(":") && r(w.offset + w.source.length - 1, "BAD_ALIAS", "Anchor ending in : is ambiguous", !0), m = w, N ?? (N = w.offset), c = !1, p = !1, y = !0;
        break;
      case "tag": {
        g && r(w, "MULTIPLE_TAGS", "A node can have at most one tag"), g = w, N ?? (N = w.offset), c = !1, p = !1, y = !0;
        break;
      }
      case t:
        (m || g) && r(w, "BAD_PROP_ORDER", `Anchors and tags must be after the ${w.source} indicator`), S && r(w, "UNEXPECTED_TOKEN", `Unexpected ${w.source} in ${e ?? "collection"}`), S = w, c = t === "seq-item-ind" || t === "explicit-key-ind", p = !1;
        break;
      case "comma":
        if (e) {
          k && r(w, "UNEXPECTED_TOKEN", `Unexpected , in ${e}`), k = w, c = !1, p = !1;
          break;
        }
      default:
        r(w, "UNEXPECTED_TOKEN", `Unexpected ${w.type} token`), c = !1, p = !1;
    }
  const E = s[s.length - 1], A = E ? E.offset + E.source.length : i;
...
function hn({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
  ...
  for (const f of n.items) {
    const { start: d, key: h, sep: y, value: u } = f, m = he(d, {
    ...
    if (g) {
      if (h && (h.type === "block-seq" ? i(a, "BLOCK_AS_IMPLICIT_KEY", "A block sequence may not be used as an implicit map key") : "indent" in h && h.indent !== n.indent && i(a, "BAD_INDENT", Pt)), !m.anchor && !m.tag && !y) {
        c = m.end, m.comment && (l.comment ? l.comment += `
` + m.comment : l.comment = m.comment);
        continue;
      }
      (m.newlineAfterProp || Oe(h)) && i(h ?? d[d.length - 1], "MULTILINE_IMPLICIT_KEY", "Implicit keys need to be on a single line");
    } else ((p = m.found) == null ? void 0 : p.indent) !== n.indent && i(a, "BAD_INDENT", Pt);
    t.atKey = !0;
    const b = m.end, k = h ? s(t, h, m, i) : e(t, b, d, null, m, i);
    t.schema.compat && dt(n.indent, h, i), t.atKey = !1, ks(t, l.items, k) && i(b, "DUPLICATE_KEY", "Map keys must be unique");
    const S = he(y ?? [], {
    ...
    if (a = S.end, S.found) {
      g && ((u == null ? void 0 : u.type) === "block-map" && !S.hasNewline && i(a, "BLOCK_AS_IMPLICIT_KEY", "Nested mappings are not allowed in compact mappings"), t.options.strict && m.start < S.found.offset - 1024 && i(k.range, "KEY_OVER_1024_CHARS", "The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));
      const N = u ? s(t, u, S, i) : e(t, a, y, null, S, i);
      t.schema.compat && dt(n.indent, u, i), a = N.range[2];
      const E = new C(k, N);
      t.options.keepSourceTokens && (E.srcToken = f), l.items.push(E);
    } else {
      g && i(k.range, "MISSING_CHAR", "Implicit map keys need to be followed by map values"), S.comment && (k.comment ? k.comment += `
` + S.comment : k.comment = S.comment);
      const N = new C(k);
      t.options.keepSourceTokens && (N.srcToken = f), l.items.push(N);
    }
  }
...
function dn({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
  const o = (r == null ? void 0 : r.nodeClass) ?? H, l = new o(t.schema);
  ...
  for (const { start: p, value: f } of n.items) {
    ...
    if (!d.found)
      if (d.anchor || d.tag || f)
        (f == null ? void 0 : f.type) === "block-seq" ? i(d.end, "BAD_INDENT", "All sequence items must start at the same column") : i(a, "MISSING_CHAR", "Sequence item without - indicator");
      else {
        c = d.end, d.comment && (l.comment = d.comment);
        continue;
      }
    const h = f ? s(t, f, d, i) : e(t, d.end, p, null, d, i);
    t.schema.compat && dt(n.indent, f, i), a = h.range[2], l.items.push(h);
  }
...
function pn({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
  var m;
  const o = n.start.source === "{", l = o ? "flow map" : "flow sequence", a = (r == null ? void 0 : r.nodeClass) ?? (o ? K : H), c = new a(t.schema);
  c.flow = !0;
  const p = t.atRoot;
  p && (t.atRoot = !1), t.atKey && (t.atKey = !1);
  let f = n.offset + n.start.source.length;
  for (let g = 0; g < n.items.length; ++g) {
    const b = n.items[g], { start: k, key: S, sep: N, value: E } = b, A = he(k, {
      flow: l,
      indicator: "explicit-key-ind",
      next: S ?? (N == null ? void 0 : N[0]),
      offset: f,
      onError: i,
      parentIndent: n.indent,
      startOnNewline: !1
    ...
    if (!A.found) {
      if (!A.anchor && !A.tag && !N && !E) {
        g === 0 && A.comma ? i(A.comma, "UNEXPECTED_TOKEN", `Unexpected , in ${l}`) : g < n.items.length - 1 && i(A.start, "UNEXPECTED_TOKEN", `Unexpected empty item in ${l}`), A.comment && (c.comment ? c.comment += `
` + A.comment : c.comment = A.comment), f = A.end;
        continue;
      }
      !o && t.options.strict && Oe(S) && i(
        S,
    ...
    if (g === 0)
      ...
      if (w) {
        ...
        L(I) && (I = I.value ?? I.key), I.comment ? I.comment += `
` + w : I.comment = w, A.comment = A.comment.substring(w.length + 1);
      }
    }
    if (!o && !N && !A.found) {
      const w = E ? s(t, E, A, i) : e(t, A.end, N, null, A, i);
      c.items.push(w), f = w.range[2], rt(E) && i(w.range, "BLOCK_IN_FLOW", it);
    } else {
      t.atKey = !0;
      const w = A.end, I = S ? s(t, S, A, i) : e(t, w, k, null, A, i);
      rt(S) && i(I.range, "BLOCK_IN_FLOW", it), t.atKey = !1;
      const v = he(N ?? [], {
        flow: l,
        indicator: "map-value-ind",
        next: E,
      ...
      } else E && ("source" in E && ((m = E.source) == null ? void 0 : m[0]) === ":" ? i(E, "MISSING_CHAR", `Missing space after : in ${l}`) : i(v.start, "MISSING_CHAR", `Missing , or : between ${l} items`));
      const J = E ? s(t, E, v, i) : v.found ? e(t, v.end, N, null, v, i) : null;
      J ? rt(E) && i(J.range, "BLOCK_IN_FLOW", it) : v.comment && (I.comment ? I.comment += `
` + v.comment : I.comment = v.comment);
      const D = new C(I, J);
      if (t.options.keepSourceTokens && (D.srcToken = b), o) {
        const q = c;
        ks(t, q.items, I) && i(w, "DUPLICATE_KEY", "Map keys must be unique"), q.items.push(D);
      } else {
        const q = new K(t.schema);
        q.flow = !0, q.items.push(D);
        const _t = (J ?? I).range;
        q.range = [I.range[0], _t[1], _t[2]], c.items.push(q);
      }
      f = J ? J.range[2] : v.end;
    }
  }
  const d = o ? "}" : "]", [h, ...y] = n.end;
  let u = f;
  if ((h == null ? void 0 : h.source) === d)
    u = h.offset + h.source.length;
  else {
    const g = l[0].toUpperCase() + l.substring(1), b = p ? `${g} must end with a ${d}` : `${g} in block collection must be sufficiently indented and end with a ${d}`;
    i(f, p ? "MISSING_CHAR" : "BAD_INDENT", b), h && h.source.length !== 1 && y.unshift(h);
  }
  if (y.length > 0) {
    const g = Ie(y, u, t.options.strict, i);
    g.comment && (c.comment ? c.comment += `
` + g.comment : c.comment = g.comment), c.range = [n.offset, u, g.offset];
  } else
...
function mn(s, e, t, n, i) {
  ...
  if (!r || !o || o === "!" || o === K.tagName && l === "map" || o === H.tagName && l === "seq")
    return ot(s, e, t, i, o);
  let a = e.schema.tags.find((h) => h.tag === o && h.collection === l);
  if (!a) {
    const h = e.schema.knownTags[o];
    if ((h == null ? void 0 : h.collection) === l)
      e.schema.tags.push(Object.assign({}, h, { default: !1 })), a = h;
    else
      return h ? i(r, "BAD_COLLECTION_TYPE", `${h.tag} used for ${l} collection, but expects ${h.collection ?? "scalar"}`, !0) : i(r, "TAG_RESOLVE_FAILED", `Unresolved tag: ${o}`, !0), ot(s, e, t, i, o);
  }
  const c = ot(s, e, t, i, o, a), p = ((d = a.resolve) == null ? void 0 : d.call(a, c, (h) => i(r, "TAG_RESOLVE_FAILED", h), e.options)) ?? c, f = _(p) ? p : new O(p);
...
function Ns(s, e, t) {
  ...
  const r = i.mode === ">" ? O.BLOCK_FOLDED : O.BLOCK_LITERAL, o = e.source ? gn(e.source) : [];
  let l = o.length;
...
`;
  for (let u = p; u < l; ++u) {
    let [m, g] = o[u];
    c += m.length + g.length + 1;
    const b = g[g.length - 1] === "\r";
    if (b && (g = g.slice(0, -1)), g && m.length < a) {
      const S = `Block scalar lines must not be less indented than their ${i.indent ? "explicit indentation indicator" : "first line"}`;
      t(c - g.length - (b ? 2 : 1), "BAD_INDENT", S), m = "";
    }
    r === O.BLOCK_LITERAL ? (f += d + m.slice(a) + g, d = `
`) : m.length > a || g[0] === "	" ? (d === " " ? d = `
` : !h && d === `
` && (d = `
...
function Os(s, e, t) {
  ...
  switch (i) {
    case "scalar":
      ...
      break;
    case "single-quoted-scalar":
      l = O.QUOTE_SINGLE, a = wn(r, c);
      break;
    case "double-quoted-scalar":
      l = O.QUOTE_DOUBLE, a = Sn(r, c);
      break;
    default:
...
function Es(s, e, t, n) {
  const { value: i, type: r, comment: o, range: l } = e.type === "block-scalar" ? Ns(s, e, n) : Os(e, s.options.strict, n), a = t ? s.directives.tagName(t.source, (f) => n(t, "TAG_RESOLVE_FAILED", f)) : null;
  let c;
  s.options.stringKeys && s.atKey ? c = s.schema[V] : a ? c = An(s.schema, i, a, t, n) : e.type === "scalar" ? c = En(s, i, e, n) : c = s.schema[V];
  let p;
  try {
...
function En({ atKey: s, directives: e, schema: t }, n, i, r) {
...
const In = { composeNode: Ts, composeEmptyNode: It };
function Ts(s, e, t, n) {
  const i = s.atKey, { spaceBefore: r, comment: o, anchor: l, tag: a } = t;
  let c, p = !0;
  switch (e.type) {
    case "alias":
      c = Ln(s, e, n), (l || a) && n(e, "ALIAS_PROPS", "An alias node must not specify any properties");
      break;
    case "scalar":
    case "single-quoted-scalar":
    case "double-quoted-scalar":
    case "block-scalar":
      c = Es(s, e, a, n), l && (c.anchor = l.source.substring(1));
      break;
    case "block-map":
    case "block-seq":
    case "flow-collection":
      try {
        c = mn(In, s, e, t, n), l && (c.anchor = l.source.substring(1));
      } catch (f) {
        const d = f instanceof Error ? f.message : String(f);
...
function It(s, e, t, n, { spaceBefore: i, comment: r, anchor: o, tag: l, end: a }, c) {
  const p = {
    type: "scalar",
    offset: Tn(e, t, n),
    indent: -1,
...
function $n(s, e, { offset: t, start: n, value: i, end: r }, o) {
  ...
  p.found && (a.directives.docStart = !0, i && (i.type === "block-map" || i.type === "block-seq") && !p.hasNewline && o(p.end, "MISSING_CHAR", "Block collection cannot start on same line with directives-end marker")), a.contents = i ? Ts(c, i, p, o) : It(c, p.end, n, null, p, o);
...
class Lt {
  constructor(e = {}) {
    this.doc = null, this.atDirectives = !1, this.prelude = [], this.errors = [], this.warnings = [], this.onError = (t, n, i, r) => {
      const o = we(t);
      r ? this.warnings.push(new Ss(o, n, i)) : this.errors.push(new Z(o, n, i));
...
${n}` : n;
        ...
        e.commentBefore = n;
      else if ($(r) && !r.flow && r.items.length > 0) {
        let o = r.items[0];
        L(o) && (o = o.key);
  ...
  *next(e) {
    switch (e.type) {
      ...
      case "newline":
        ...
        break;
      case "error": {
        const t = e.source ? `${e.message}: ${JSON.stringify(e.source)}` : e.message, n = new Z(we(e), "UNEXPECTED_TOKEN", t);
      ...
      case "doc-end": {
        if (!this.doc) {
          ...
          this.errors.push(new Z(we(e), "UNEXPECTED_TOKEN", n));
          break;
        }
...
${t.comment}` : t.comment;
      ...
      default:
        this.errors.push(new Z(we(e), "UNEXPECTED_TOKEN", `Unsupported token ${e.type}`));
    }
  }
  /**
  ...
  if (s) {
    ...
    switch (s.type) {
      ...
      case "double-quoted-scalar":
        return Os(s, e, n);
      case "block-scalar":
        return Ns({ options: { strict: e } }, s, n);
    }
  }
  return null;
}
...
`, d = [
      ...
      return Is(d, a) || d.push({ type: "newline", offset: -1, indent: n, source: `
...
`;
  if (s.type === "block-scalar") {
    ...
    Is(l, "end" in s ? s.end : void 0) || l.push({ type: "newline", offset: -1, indent: o, source: `
` });
...
const Mn = (s) => "type" in s ? Re(s) : Pe(s);
function Re(s) {
  switch (s.type) {
    case "block-scalar": {
      let e = "";
...
function Pe({ start: s, key: e, sep: t, value: n }) {
  let i = "";
  for (const r of s)
    i += r.source;
  if (e && (i += Re(e)), t)
...
const pt = Symbol("break visit"), Kn = Symbol("skip children"), Ls = Symbol("remove item");
function x(s, e) {
  "type" in s && s.type === "document" && (s = { start: s.start, value: s.value }), $s(Object.freeze([]), s, e);
}
x.BREAK = pt;
x.SKIP = Kn;
x.REMOVE = Ls;
  ...
  for (const i of ["key", "value"]) {
    ...
    if (r && "items" in r) {
      for (let o = 0; o < r.items.length; ++o) {
        const l = $s(Object.freeze(s.concat([[i, o]])), r.items[o], t);
        if (typeof l == "number")
          o = l - 1;
        else {
          if (l === pt)
            return pt;
          l === Ls && (r.items.splice(o, 1), o -= 1);
        }
      }
...
const xe = "\uFEFF", et = "", tt = "", Ae = "", Pn = (s) => !!s && "items" in s, jn = (s) => !!s && (s.type === "scalar" || s.type === "single-quoted-scalar" || s.type === "double-quoted-scalar" || s.type === "block-scalar");
function Dn(s) {
  switch (s) {
    case xe:
      return "<BOM>";
...
const Dt = new Set("0123456789ABCDEFabcdef"), Rn = new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"), Ce = new Set(",[]{}"), Un = new Set(` ,[]{}
\r	`), at = (s) => !s || Un.has(s);
class Cs {
  constructor() {
...
`, this.pos), this.lineEndPos = e), e === -1 ? this.atEnd ? this.buffer.substring(this.pos) : null : (this.buffer[e - 1] === "\r" && (e -= 1), this.buffer.substring(this.pos, e));
  ...
  *parseStream() {
    ...
    return yield et, yield* this.parseLineStart();
  }
  *parseLineStart() {
  ...
  *parsePlainScalar() {
    ...
    for (; i = this.buffer[++n]; )
      if (i === ":") {
        ...
        if (i === "\r" && (r === `
` ? (n += 1, i = `
`, r = this.buffer[n + 1]) : t = n), r === "#" || e && Ce.has(r))
          break;
        if (i === `
`) {
    ...
    e: for (; ; ) {
      switch (this.charAt(0)) {
        case "!":
          ...
          continue e;
        case "&":
          e += yield* this.pushUntil(at), e += yield* this.pushSpaces(!0);
          continue e;
        case "-":
        case "?":
        case ":": {
  ...
  *pushTag() {
    if (this.charAt(1) === "<") {
      ...
      for (; t; )
        if (Rn.has(t))
          t = this.buffer[++e];
        else if (t === "%" && Dt.has(this.buffer[e + 1]) && Dt.has(this.buffer[e + 2]))
          t = this.buffer[e += 3];
        else
          break;
...
function Rt(s) {
  if (s.start.type === "flow-seq-start")
    for (const e of s.items)
      e.sep && !e.value && !Q(e.start, "explicit-key-ind") && !Q(e.sep, "map-value-ind") && (e.key && (e.value = e.key), delete e.key, Bs(e.value) ? e.value.end ? Ue(e.value.end, e.sep) : e.value.end = e.sep : Ue(e.start, e.sep), delete e.sep);
}
class $t {
  /**
   ...
   */
  constructor(e) {
    this.atNewLine = !0, this.atScalar = !1, this.indent = 0, this.offset = 0, this.onKeyLine = !1, this.stack = [], this.source = "", this.type = "", this.lexer = new Cs(), this.onNewLine = e;
  }
  /**
  ...
  *pop(e) {
    ...
    if (!t)
      ...
      if ((n.type === "document" || n.type === "block-map" || n.type === "block-seq") && (t.type === "block-map" || t.type === "block-seq")) {
        ...
        i && !i.sep && !i.value && i.start.length > 0 && qt(i.start) === -1 && (t.indent === 0 || i.start.every((r) => r.type !== "comment" || r.indent < t.indent)) && (n.type === "document" ? n.end = i.start : n.items.push({ start: i.start }), t.items.splice(-1, 1));
      }
    }
  }
  *stream() {
  ...
  *document(e) {
    ...
    switch (this.type) {
      case "doc-start": {
        qt(e.start) !== -1 ? (yield* this.pop(), yield* this.step()) : e.start.push(this.sourceToken);
        return;
      }
      case "anchor":
      case "tag":
        ...
        case "map-value-ind":
          if (t.explicitKey)
            if (t.sep)
              ...
              else if (Bs(t.key) && !Q(t.sep, "newline")) {
                const l = ie(t.start), a = t.key, c = t.sep;
...
function Ms(s) {
  ...
  return { lineCounter: s.lineCounter || e && new vs() || null, prettyErrors: e };
}
function Fn(s, e = {}) {
  const { lineCounter: t, prettyErrors: n } = Ms(e), i = new $t(t == null ? void 0 : t.addNewLine), r = new Lt(e), o = Array.from(r.compose(i.parse(s)));
  if (n && t)
    for (const l of o)
...
function Ks(s, e = {}) {
  const { lineCounter: t, prettyErrors: n } = Ms(e), i = new $t(t == null ? void 0 : t.addNewLine), r = new Lt(e);
  let o = null;
...
function Jn(s, e, t) {
  ...
  return te(s) && !n ? s.toString(t) : new be(s, n, t).toString(t);
}
