import { _ as Xa } from "./jspdf.es.min-Dm4yIRFU.js";
...
}, Lo = {}, ko = {}.propertyIsEnumerable, Bo = Object.getOwnPropertyDescriptor, Il = Bo && !ko.call({ 1: 2 }, 1);
Lo.f = Il ? function(e) {
  var t = Bo(this, e);
...
}, jo = br, Fo = Function.prototype, Wa = Fo.call, Ml = jo && Fo.bind.bind(Wa, Wa), L = jo ? Ml : function(a) {
  return function() {
    return Wa.apply(a, arguments);
  };
}, Uo = L, _l = Uo({}.toString), Vl = Uo("".slice), Ce = function(a) {
  return Vl(_l(a), 8, -1);
}, Dl = L, Ll = D, kl = Ce, ea = Object, Bl = Dl("".split), Go = Ll(function() {
...
}, ra = _, Hl = k, Yl = function(a) {
  return Hl(a) ? a : void 0;
}, Fe = function(a, e) {
  return arguments.length < 2 ? Yl(ra[a]) : ra[a] && ra[a][e];
}, Xl = L, Tr = Xl({}.isPrototypeOf), Wl = _, pn = Wl.navigator, yn = pn && pn.userAgent, Ct = yn ? String(yn) : "", zo = _, aa = Ct, mn = zo.process, bn = zo.Deno, xn = mn && mn.versions || bn && bn.version, Tn = xn && xn.v8, le, cr;
Tn && (le = Tn.split("."), cr = le[0] > 0 && le[0] < 4 ? 1 : +(le[0] + le[1]));
!cr && aa && (le = aa.match(/Edge\/(\d+)/), (!le || le[1] >= 74) && (le = aa.match(/Chrome\/(\d+)/), le && (cr = +le[1])));
var Ei = cr, On = Ei, ql = D, Ql = _, Kl = Ql.String, Ho = !!Object.getOwnPropertySymbols && !ql(function() {
...
}), Zl = Ho, Yo = Zl && !Symbol.sham && typeof Symbol.iterator == "symbol", Jl = Fe, eh = k, th = Tr, rh = Yo, ah = Object, Xo = rh ? function(a) {
...
}, nh = k, sh = Or, oh = TypeError, Ae = function(a) {
  if (nh(a)) return a;
  throw new oh(sh(a) + " is not a function");
}, uh = Ae, lh = xr, ot = function(a, e) {
  var t = a[e];
  return lh(t) ? void 0 : uh(t);
}, ia = Y, na = k, sa = ae, hh = TypeError, vh = function(a, e) {
  var t, r;
  if (e === "string" && na(t = a.toString) && !sa(r = ia(t, a)) || na(t = a.valueOf) && !sa(r = ia(t, a)) || e !== "string" && na(t = a.toString) && !sa(r = ia(t, a))) return r;
  throw new hh("Can't convert object to primitive value");
}, Wo = { exports: {} }, Sn = _, fh = Object.defineProperty, $i = function(a, e) {
  try {
  ...
  return e;
}, ch = _, gh = $i, En = "__core-js_shared__", $n = Wo.exports = ch[En] || gh(En, {});
...
var wi = Wo.exports, wn = wi, dh = Object.create || Object, Ci = function(a, e) {
  return wn[a] || (wn[a] = e || dh(null));
}, ph = ve, yh = Object, Sr = function(a) {
  return yh(ph(a));
}, mh = L, bh = Sr, xh = mh({}.hasOwnProperty), fe = Object.hasOwn || function(e, t) {
  return xh(bh(e), t);
}, Th = L, Oh = 0, Sh = Math.random(), Eh = Th(1.1.toString), qo = function(a) {
  return "Symbol(" + (a === void 0 ? "" : a) + ")_" + Eh(++Oh + Sh, 36);
}, $h = _, wh = Ci, Cn = fe, Ch = qo, Ah = Ho, Ph = Yo, Ze = $h.Symbol, oa = wh("wks"), Rh = Ph ? Ze.for || Ze : Ze && Ze.withoutSetter || Ch, z = function(a) {
  return Cn(oa, a) || (oa[a] = Ah && Cn(Ze, a) ? Ze[a] : Rh("Symbol." + a)), oa[a];
}, Nh = Y, An = ae, Pn = Xo, Ih = ot, Mh = vh, _h = z, Vh = TypeError, Dh = _h("toPrimitive"), Lh = function(a, e) {
  if (!An(a) || Pn(a)) return a;
  var t = Ih(a, Dh), r;
  if (t) {
    if (e === void 0 && (e = "default"), r = Nh(t, a, e), !An(r) || Pn(r)) return r;
    throw new Vh("Can't convert object to primitive value");
  }
  return e === void 0 && (e = "number"), Mh(a, e);
}, kh = Lh, Bh = Xo, Qo = function(a) {
  var e = kh(a, "string");
  return Bh(e) ? e : e + "";
}, jh = _, Rn = ae, qa = jh.document, Fh = Rn(qa) && Rn(qa.createElement), Er = function(a) {
  return Fh ? qa.createElement(a) : {};
}, Uh = he, Gh = D, zh = Er, Ko = !Uh && !Gh(function() {
  return Object.defineProperty(zh("div"), "a", {
    get: function() {
      return 7;
    }
  }).a !== 7;
}), Hh = he, Yh = Y, Xh = Lo, Wh = Si, qh = wt, Qh = Qo, Kh = fe, Zh = Ko, Nn = Object.getOwnPropertyDescriptor;
$t.f = Hh ? Nn : function(e, t) {
  if (e = qh(e), t = Qh(t), Zh) try {
    return Nn(e, t);
  } catch {
  }
  if (Kh(e, t)) return Wh(!Yh(Xh.f, e, t), e[t]);
};
var Te = {}, Jh = he, ev = D, Zo = Jh && ev(function() {
  return Object.defineProperty(function() {
  }, "prototype", {
    value: 42,
    writable: !1
  }).prototype !== 42;
}), tv = ae, rv = String, av = TypeError, J = function(a) {
  if (tv(a)) return a;
  throw new av(rv(a) + " is not an object");
}, iv = he, nv = Ko, sv = Zo, Ut = J, In = Qo, ov = TypeError, ua = Object.defineProperty, uv = Object.getOwnPropertyDescriptor, la = "enumerable", ha = "configurable", va = "writable";
Te.f = iv ? sv ? function(e, t, r) {
  if (Ut(e), t = In(t), Ut(r), typeof e == "function" && t === "prototype" && "value" in r && va in r && !r[va]) {
    var i = uv(e, t);
...
var lv = he, hv = Te, vv = Si, At = lv ? function(a, e, t) {
  return hv.f(a, e, vv(1, t));
} : function(a, e, t) {
  return a[e] = t, a;
}, Jo = { exports: {} }, Qa = he, fv = fe, eu = Function.prototype, cv = Qa && Object.getOwnPropertyDescriptor, tu = fv(eu, "name"), gv = tu && (function() {
}).name === "something", dv = tu && (!Qa || Qa && cv(eu, "name").configurable), $r = {
  PROPER: gv,
  CONFIGURABLE: dv
}, pv = L, yv = k, Ka = wi, mv = pv(Function.toString);
yv(Ka.inspectSource) || (Ka.inspectSource = function(a) {
  return mv(a);
});
var Ai = Ka.inspectSource, bv = _, xv = k, Mn = bv.WeakMap, Tv = xv(Mn) && /native code/.test(String(Mn)), Ov = Ci, Sv = qo, _n = Ov("keys"), Pi = function(a) {
  return _n[a] || (_n[a] = Sv(a));
}, Ri = {}, Ev = Tv, ru = _, $v = ae, wv = At, fa = fe, ca = wi, Cv = Pi, Av = Ri, Vn = "Object already initialized", Za = ru.TypeError, Pv = ru.WeakMap, gr, Ot, dr, Rv = function(a) {
  return dr(a) ? Ot(a) : gr(a, {});
}, Nv = function(a) {
  return function(e) {
    var t;
    if (!$v(e) || (t = Ot(e)).type !== a)
      throw new Za("Incompatible receiver, " + a + " required");
    return t;
  };
};
if (Ev || ca.state) {
  var de = ca.state || (ca.state = new Pv());
  de.get = de.get, de.has = de.has, de.set = de.set, gr = function(a, e) {
    if (de.has(a)) throw new Za(Vn);
  ...
  var Ye = Cv("state");
  Av[Ye] = !0, gr = function(a, e) {
    if (fa(a, Ye)) throw new Za(Vn);
    return e.facade = a, wv(a, Ye, e), e;
  }, Ot = function(a) {
    return fa(a, Ye) ? a[Ye] : {};
  }, dr = function(a) {
    return fa(a, Ye);
...
var wr = {
  ...
  enforce: Rv,
  getterFor: Nv
}, Ni = L, Iv = D, Mv = k, Gt = fe, Ja = he, _v = $r.CONFIGURABLE, Vv = Ai, au = wr, Dv = au.enforce, Lv = au.get, Dn = String, or = Object.defineProperty, kv = Ni("".slice), Bv = Ni("".replace), jv = Ni([].join), Fv = Ja && !Iv(function() {
  return or(function() {
  }, "length", { value: 8 }).length !== 8;
}), Uv = String(String).split("String"), Gv = Jo.exports = function(a, e, t) {
  kv(Dn(e), 0, 7) === "Symbol(" && (e = "[" + Bv(Dn(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), t && t.getter && (e = "get " + e), t && t.setter && (e = "set " + e), (!Gt(a, "name") || _v && a.name !== e) && (Ja ? or(a, "name", { value: e, configurable: !0 }) : a.name = e), Fv && t && Gt(t, "arity") && a.length !== t.arity && or(a, "length", { value: t.arity });
  try {
    t && Gt(t, "constructor") && t.constructor ? Ja && or(a, "prototype", { writable: !1 }) : a.prototype && (a.prototype = void 0);
  } catch {
  }
  var r = Dv(a);
  return Gt(r, "source") || (r.source = jv(Uv, typeof e == "string" ? e : "")), a;
};
Function.prototype.toString = Gv(function() {
  return Mv(this) && Lv(this).source || Vv(this);
}, "toString");
var iu = Jo.exports, zv = k, Hv = Te, Yv = iu, Xv = $i, Ue = function(a, e, t, r) {
  r || (r = {});
  var i = r.enumerable, n = r.name !== void 0 ? r.name : e;
  if (zv(t) && Yv(t, n, r), r.global)
    i ? a[e] = t : Xv(e, t);
  else {
    try {
  ...
  return a;
}, nu = {}, Wv = Math.ceil, qv = Math.floor, Qv = Math.trunc || function(e) {
  var t = +e;
  return (t > 0 ? qv : Wv)(t);
}, Kv = Qv, Cr = function(a) {
  var e = +a;
  return e !== e || e === 0 ? 0 : Kv(e);
}, Zv = Cr, Jv = Math.max, ef = Math.min, tf = function(a, e) {
  var t = Zv(a);
  return t < 0 ? Jv(t + e, 0) : ef(t, e);
}, rf = Cr, af = Math.min, ut = function(a) {
  var e = rf(a);
  return e > 0 ? af(e, 9007199254740991) : 0;
}, nf = ut, Ii = function(a) {
  return nf(a.length);
}, sf = wt, of = tf, uf = Ii, lf = function(a) {
  ...
  indexOf: lf(!1)
}, hf = L, ga = fe, vf = wt, ff = su.indexOf, cf = Ri, Ln = hf([].push), ou = function(a, e) {
  var t = vf(a), r = 0, i = [], n;
  for (n in t) !ga(cf, n) && ga(t, n) && Ln(i, n);
  for (; e.length > r; ) ga(t, n = e[r++]) && (~ff(i, n) || Ln(i, n));
  return i;
}, Mi = [
  "constructor",
  "hasOwnProperty",
  ...
  "toString",
  "valueOf"
], gf = ou, df = Mi, pf = df.concat("length", "prototype");
nu.f = Object.getOwnPropertyNames || function(e) {
  return gf(e, pf);
};
var uu = {};
uu.f = Object.getOwnPropertySymbols;
var yf = Fe, mf = L, bf = nu, xf = uu, Tf = J, Of = mf([].concat), Sf = yf("Reflect", "ownKeys") || function(e) {
  var t = bf.f(Tf(e)), r = xf.f;
  return r ? Of(t, r(e)) : t;
}, kn = fe, Ef = Sf, $f = $t, wf = Te, Cf = function(a, e, t) {
  for (var r = Ef(e), i = wf.f, n = $f.f, o = 0; o < r.length; o++) {
    var s = r[o];
    !kn(a, s) && !(t && kn(t, s)) && i(a, s, n(e, s));
  }
}, Af = D, Pf = k, Rf = /#|\.prototype\./, Pt = function(a, e) {
  var t = If[Nf(a)];
  return t === _f ? !0 : t === Mf ? !1 : Pf(e) ? Af(e) : !!e;
}, Nf = Pt.normalize = function(a) {
  return String(a).replace(Rf, ".").toLowerCase();
}, If = Pt.data = {}, Mf = Pt.NATIVE = "N", _f = Pt.POLYFILL = "P", lu = Pt, zt = _, Vf = $t.f, Df = At, Lf = Ue, kf = $i, Bf = Cf, jf = lu, ee = function(a, e) {
  var t = a.target, r = a.global, i = a.stat, n, o, s, u, l, h;
  if (r ? o = zt : i ? o = zt[t] || kf(t, {}) : o = zt[t] && zt[t].prototype, o) for (s in e) {
    if (l = e[s], a.dontCallGetSet ? (h = Vf(o, s), u = h && h.value) : u = o[s], n = jf(r ? s : t + (i ? "." : "#") + s, a.forced), !n && u !== void 0) {
      if (typeof l == typeof u) continue;
      Bf(l, u);
    }
    (a.sham || u && u.sham) && Df(l, "sham", !0), Lf(o, s, l, a);
  }
}, ft = _, Ff = Ct, Uf = Ce, Ht = function(a) {
  return Ff.slice(0, a.length) === a;
}, hu = function() {
  return Ht("Bun/") ? "BUN" : Ht("Cloudflare-Workers") ? "CLOUDFLARE" : Ht("Deno/") ? "DENO" : Ht("Node.js/") ? "NODE" : ft.Bun && typeof Bun.version == "string" ? "BUN" : ft.Deno && typeof Deno.version == "object" ? "DENO" : Uf(ft.process) === "process" ? "NODE" : ft.window && ft.document ? "BROWSER" : "REST";
}(), Gf = hu, Ar = Gf === "NODE", zf = _, Hf = zf, Yf = L, Xf = Ae, Wf = function(a, e, t) {
  try {
    return Yf(Xf(Object.getOwnPropertyDescriptor(a, e)[t]));
  } catch {
  }
}, qf = ae, Qf = function(a) {
  return qf(a) || a === null;
}, Kf = Qf, Zf = String, Jf = TypeError, ec = function(a) {
  if (Kf(a)) return a;
  throw new Jf("Can't set " + Zf(a) + " as a prototype");
}, tc = Wf, rc = ae, ac = ve, ic = ec, vu = Object.setPrototypeOf || ("__proto__" in {} ? function() {
  var a = !1, e = {}, t;
  try {
    t = tc(Object.prototype, "__proto__", "set"), t(e, []), a = e instanceof Array;
  } catch {
  }
  return function(i, n) {
    return ac(i), ic(n), rc(i) && (a ? t(i, n) : i.__proto__ = n), i;
  };
}() : void 0), nc = Te.f, sc = fe, oc = z, Bn = oc("toStringTag"), Pr = function(a, e, t) {
  a && !t && (a = a.prototype), a && !sc(a, Bn) && nc(a, Bn, { configurable: !0, value: e });
}, jn = iu, uc = Te, lc = function(a, e, t) {
  return t.get && jn(t.get, e, { getter: !0 }), t.set && jn(t.set, e, { setter: !0 }), uc.f(a, e, t);
}, hc = Fe, vc = lc, fc = z, cc = he, Fn = fc("species"), gc = function(a) {
  var e = hc(a);
  cc && e && !e[Fn] && vc(e, Fn, {
    configurable: !0,
    get: function() {
...
}, dc = Tr, pc = TypeError, yc = function(a, e) {
  if (dc(e, a)) return a;
  throw new pc("Incorrect invocation");
}, mc = z, bc = mc("toStringTag"), fu = {};
fu[bc] = "z";
var xc = String(fu) === "[object z]", Tc = xc, Oc = k, ur = Ce, Sc = z, Ec = Sc("toStringTag"), $c = Object, wc = ur(/* @__PURE__ */ function() {
  return arguments;
  ...
  var e, t, r;
  return a === void 0 ? "Undefined" : a === null ? "Null" : typeof (t = Cc(e = $c(a), Ec)) == "string" ? t : wc ? ur(e) : (r = ur(e)) === "Object" && Oc(e.callee) ? "Arguments" : r;
}, Ac = L, Pc = D, gu = k, Rc = cu, Nc = Fe, Ic = Ai, du = function() {
}, pu = Nc("Reflect", "construct"), _i = /^\s*(?:class|function)\b/, Mc = Ac(_i.exec), _c = !_i.test(du), ct = function(e) {
  if (!gu(e)) return !1;
  try {
    return pu(du, [], e), !0;
  } catch {
  ...
  try {
    return _c || !!Mc(_i, Ic(e));
  } catch {
    return !0;
  }
};
yu.sham = !0;
var Vc = !pu || Pc(function() {
  var a;
  return ct(ct.call) || !ct(Object) || !ct(function() {
    a = !0;
  }) || a;
}) ? yu : ct, Dc = Vc, Lc = Or, kc = TypeError, Bc = function(a) {
  if (Dc(a)) return a;
  throw new kc(Lc(a) + " is not a constructor");
}, Un = J, jc = Bc, Fc = xr, Uc = z, Gc = Uc("species"), mu = function(a, e) {
  var t = Un(a).constructor, r;
  return t === void 0 || Fc(r = Un(t)[Gc]) ? e : jc(r);
}, zc = br, bu = Function.prototype, Gn = bu.apply, zn = bu.call, xu = typeof Reflect == "object" && Reflect.apply || (zc ? zn.bind(Gn) : function() {
  return zn.apply(Gn, arguments);
}), Hc = Ce, Yc = L, Rr = function(a) {
  if (Hc(a) === "Function") return Yc(a);
}, Hn = Rr, Xc = Ae, Wc = br, qc = Hn(Hn.bind), Vi = function(a, e) {
  return Xc(a), e === void 0 ? a : Wc ? qc(a, e) : function() {
    return a.apply(e, arguments);
  };
}, Qc = Fe, Tu = Qc("document", "documentElement"), Kc = L, Zc = Kc([].slice), Jc = TypeError, eg = function(a, e) {
  if (a < e) throw new Jc("Not enough arguments");
  return a;
}, Yn = Ct, Ou = /ipad|iphone|ipod/i.test(Yn) && /applewebkit/i.test(Yn), ie = _, tg = xu, rg = Vi, Xn = k, ag = fe, Su = D, Wn = Tu, ig = Zc, qn = Er, ng = eg, sg = Ou, og = Ar, ei = ie.setImmediate, Qn = ie.clearImmediate, ug = ie.process, da = ie.Dispatch, lg = ie.Function, Kn = ie.MessageChannel, hg = ie.String, pa = 0, xt = {}, Zn = "onreadystatechange", St, Me, ya, ma;
Su(function() {
  St = ie.location;
});
var Di = function(a) {
  ...
  ie.postMessage(hg(a), St.protocol + "//" + St.host);
};
(!ei || !Qn) && (ei = function(e) {
  ng(arguments.length, 1);
  var t = Xn(e) ? e : lg(e), r = ig(arguments, 1);
  ...
  da.now(ba(a));
} : Kn && !sg ? (ya = new Kn(), ma = ya.port2, ya.port1.onmessage = Jn, Me = rg(ma.postMessage, ma)) : ie.addEventListener && Xn(ie.postMessage) && !ie.importScripts && St && St.protocol !== "file:" && !Su(es) ? (Me = es, ie.addEventListener("message", Jn, !1)) : Zn in qn("script") ? Me = function(a) {
  Wn.appendChild(qn("script"))[Zn] = function() {
    Wn.removeChild(this), Di(a);
  };
} : Me = function(a) {
  setTimeout(ba(a), 0);
});
var Eu = {
  set: ei
}, ts = _, vg = he, fg = Object.getOwnPropertyDescriptor, cg = function(a) {
  if (!vg) return ts[a];
  var e = fg(ts, a);
  return e && e.value;
}, $u = function() {
...
var wu = $u, gg = Ct, dg = /ipad|iphone|ipod/i.test(gg) && typeof Pebble < "u", pg = Ct, yg = /web0s(?!.*chrome)/i.test(pg), it = _, mg = cg, rs = Vi, xa = Eu.set, bg = wu, xg = Ou, Tg = dg, Og = yg, Ta = Ar, as = it.MutationObserver || it.WebKitMutationObserver, is = it.document, ns = it.process, Yt = it.Promise, ti = mg("queueMicrotask"), Xe, Oa, Sa, Xt, ss;
if (!ti) {
  var Wt = new bg(), qt = function() {
    var a, e;
    for (Ta && (a = ns.domain) && a.exit(); e = Wt.get(); ) try {
      e();
    } catch (t) {
      throw Wt.head && Xe(), t;
    }
  ...
  !xg && !Ta && !Og && as && is ? (Oa = !0, Sa = is.createTextNode(""), new as(qt).observe(Sa, { characterData: !0 }), Xe = function() {
    Sa.data = Oa = !Oa;
  }) : !Tg && Yt && Yt.resolve ? (Xt = Yt.resolve(void 0), Xt.constructor = Yt, ss = rs(Xt.then, Xt), Xe = function() {
    ss(qt);
  }) : Ta ? Xe = function() {
    ns.nextTick(qt);
  } : (xa = rs(xa, it), Xe = function() {
    xa(qt);
  }), ti = function(a) {
    Wt.head || Xe(), Wt.add(a);
  };
}
var Sg = ti, Eg = function(a, e) {
  try {
...
}, $g = _, Nr = $g.Promise, wg = _, Tt = Nr, Cg = k, Ag = lu, Pg = Ai, Rg = z, os = hu, Ea = Ei;
Tt && Tt.prototype;
var Ng = Rg("species"), ri = !1, Cu = Cg(wg.PromiseRejectionEvent), Ig = Ag("Promise", function() {
  var a = Pg(Tt), e = a !== String(Tt);
  if (!e && Ea === 66) return !0;
  if (!Ea || Ea < 51 || !/native code/.test(a)) {
    ...
    if (i[Ng] = r, ri = t.then(function() {
    }) instanceof r, !ri) return !0;
  }
  return !e && (os === "BROWSER" || os === "DENO") && !Cu;
}), Rt = {
  CONSTRUCTOR: Ig,
  REJECTION_EVENT: Cu,
  SUBCLASSING: ri
}, lt = {}, us = Ae, Mg = TypeError, _g = function(a) {
  var e, t;
  this.promise = new a(function(r, i) {
    if (e !== void 0 || t !== void 0) throw new Mg("Bad Promise constructor");
    e = r, t = i;
...
var Vg = ee, pr = Ar, $e = _, Dg = Hf, nt = Y, ls = Ue, hs = vu, Lg = Pr, kg = gc, Bg = Ae, lr = k, jg = ae, Fg = yc, Ug = mu, Au = Eu.set, ki = Sg, Gg = Eg, zg = Li, Hg = wu, Pu = wr, yr = Nr, Bi = Rt, Ru = lt, Ir = "Promise", Nu = Bi.CONSTRUCTOR, Yg = Bi.REJECTION_EVENT, Xg = Bi.SUBCLASSING, $a = Pu.getterFor(Ir), Wg = Pu.set, Qe = yr && yr.prototype, ke = yr, Qt = Qe, Iu = $e.TypeError, ai = $e.document, ji = $e.process, ii = Ru.f, qg = ii, Qg = !!(ai && ai.createEvent && $e.dispatchEvent), Mu = "unhandledrejection", Kg = "rejectionhandled", vs = 0, _u = 1, Zg = 2, Fi = 1, Vu = 2, Kt, fs, Du, cs, Lu = function(a) {
  var e;
  return jg(a) && lr(e = a.then) ? e : !1;
}, ku = function(a, e) {
  var t = e.value, r = e.state === _u, i = r ? a.ok : a.fail, n = a.resolve, o = a.reject, s = a.domain, u, l, h;
  try {
    i ? (r || (e.rejection === Vu && ed(e), e.rejection = Fi), i === !0 ? u = t : (s && s.enter(), u = i(t), s && (s.exit(), h = !0)), u === a.promise ? o(new Iu("Promise-chain cycle")) : (l = Lu(u)) ? nt(l, u, n, o) : n(u)) : o(t);
  } catch (f) {
    s && !h && s.exit(), o(f);
  }
}, Bu = function(a, e) {
  a.notified || (a.notified = !0, ki(function() {
  ...
  var r, i;
  Qg ? (r = ai.createEvent("Event"), r.promise = e, r.reason = t, r.initEvent(a, !1, !0), $e.dispatchEvent(r)) : r = { promise: e, reason: t }, !Yg && (i = $e["on" + a]) ? i(r) : a === Mu && Gg("Unhandled promise rejection", t);
}, Jg = function(a) {
  nt(Au, $e, function() {
    var e = a.facade, t = a.value, r = gs(a), i;
    if (r && (i = zg(function() {
      pr ? ji.emit("unhandledRejection", t, e) : ju(Mu, e, t);
    }), a.rejection = pr || gs(a) ? Vu : Fi, i.error))
      throw i.value;
  });
}, gs = function(a) {
  ...
  nt(Au, $e, function() {
    var e = a.facade;
    pr ? ji.emit("rejectionHandled", e) : ju(Kg, e, a.value);
  });
}, Je = function(a, e, t) {
  return function(r) {
    a(e, r, t);
  ...
  a.done || (a.done = !0, t && (a = t), a.value = e, a.state = Zg, Bu(a, !0));
}, ni = function(a, e, t) {
  if (!a.done) {
    a.done = !0, t && (a = t);
    try {
...
if (Nu && (ke = function(e) {
  ...
  var r = $a(this), i = ii(Ug(this, ke));
  return r.parent = !0, i.ok = lr(e) ? e : !0, i.fail = lr(t) && t, i.domain = pr ? ji.domain : void 0, r.state === vs ? r.reactions.add(i) : ki(function() {
    ku(i, r);
  }), i.promise;
}), fs = function() {
  var a = new Kt(), e = $a(a);
  this.promise = a, this.resolve = Je(ni, e), this.reject = Je(tt, e);
}, Ru.f = ii = function(a) {
  return a === ke || a === Du ? new fs(a) : qg(a);
}, lr(yr) && Qe !== Object.prototype)) {
  cs = Qe.then, Xg || ls(Qe, "then", function(e, t) {
    var r = this;
...
Vg({ global: !0, constructor: !0, wrap: !0, forced: Nu }, {
  Promise: ke
});
Du = Dg.Promise;
Lg(ke, Ir, !1);
kg(Ir);
var Mr = Object.create ? /* @__PURE__ */ Object.create(null) : {}, td = z, rd = Mr, ad = td("iterator"), id = Array.prototype, nd = function(a) {
  return a !== void 0 && (rd.Array === a || id[ad] === a);
}, sd = Ce, od = xr, ds = ot, ud = z, ps = ud("iterator"), ld = Array.prototype, Fu = function(a) {
  if (!od(a)) return ds(a, ps) || ds(a, "@@iterator") || (sd(a) === "Arguments" ? ld[ps] : void 0);
}, hd = Y, vd = k, fd = J, cd = Or, gd = Fu, dd = TypeError, pd = function(a, e) {
  var t = arguments.length < 2 ? gd(a) : e;
  if (vd(t)) return fd(hd(t, a));
  throw new dd(cd(a) + " is not iterable");
}, yd = Y, ys = J, md = ot, bd = function(a, e, t) {
  var r, i;
  ys(a);
  try {
    if (r = md(a, "return"), !r) {
  ...
  if (i) throw r;
  return ys(r), t;
}, xd = Vi, Td = Y, Od = J, Sd = Or, Ed = nd, $d = Ii, ms = Tr, wd = pd, Cd = Fu, bs = bd, Ad = TypeError, hr = function(a, e) {
  this.stopped = a, this.result = e;
}, xs = hr.prototype, Uu = function(a, e, t) {
  var r = t && t.that, i = !!(t && t.AS_ENTRIES), n = !!(t && t.IS_RECORD), o = !!(t && t.IS_ITERATOR), s = !!(t && t.INTERRUPTED), u = xd(e, r), l, h, f, c, v, g, d, p = function(b) {
    var x = l;
    return l = void 0, x && bs(x, "normal"), new hr(!0, b);
  }, y = function(b) {
    return i ? (Od(b), s ? u(b[0], b[1], p) : u(b[0], b[1])) : s ? u(b, p) : u(b);
  };
  if (n)
    l = a.iterator;
  else if (o)
  ...
  for (g = n ? a.next : l.next; !(d = Td(g, l)).done; ) {
    ...
    if (typeof v == "object" && v && ms(xs, v)) return v;
  }
  return new hr(!1);
}, Pd = z, Gu = Pd("iterator"), zu = !1;
try {
  var Rd = 0, Ts = {
    next: function() {
      return { done: !!Rd++ };
...
var Nd = function(a, e) {
  ...
  return t;
}, Id = Nr, Md = Nd, _d = Rt.CONSTRUCTOR, Hu = _d || !Md(function(a) {
  Id.all(a).then(void 0, function() {
  });
}), Vd = ee, Dd = Y, Ld = Ae, kd = lt, Bd = Li, jd = Uu, Fd = Hu;
...
var Ud = ee, Gd = Rt.CONSTRUCTOR, si = Nr, zd = Fe, Hd = k, Yd = Ue, Os = si && si.prototype;
...
if (Hd(si)) {
  var Ss = zd("Promise").prototype.catch;
  Os.catch !== Ss && Yd(Os, "catch", Ss, { unsafe: !0 });
}
var Xd = ee, Wd = Y, qd = Ae, Qd = lt, Kd = Li, Zd = Uu, Jd = Hu;
...
var ep = ee, tp = lt, rp = Rt.CONSTRUCTOR;
...
var ap = J, ip = ae, np = lt, sp = function(a, e) {
  if (ap(a), ip(e) && e.constructor === a) return e;
  var t = np.f(a), r = t.resolve;
  return r(e), t.promise;
}, op = ee, up = Fe, lp = Rt.CONSTRUCTOR, hp = sp;
up("Promise");
...
function xe(a) {
  return function() {
    ...
    return new Promise(function(r, i) {
      ...
      function s(u) {
        Es(n, r, i, o, s, "throw", u);
      }
      o(void 0);
    });
  };
}
var vp = cu, fp = String, pe = function(a) {
...
}, Ui = D, gp = _, Gi = gp.RegExp, zi = Ui(function() {
  var a = Gi("a", "y");
...
var dp = zi || Ui(function() {
  var a = Gi("^r", "gy");
  return a.lastIndex = 2, a.exec("str") !== null;
}), Xu = {
  BROKEN_CARET: dp,
  UNSUPPORTED_Y: zi
}, Wu = {}, pp = ou, yp = Mi, mp = Object.keys || function(e) {
  return pp(e, yp);
}, bp = he, xp = Zo, Tp = Te, Op = J, Sp = wt, Ep = mp;
Wu.f = bp && !xp ? Object.defineProperties : function(e, t) {
  Op(e);
  for (var r = Sp(t), i = Ep(t), n = i.length, o = 0, s; n > o; ) Tp.f(e, s = i[o++], r[s]);
  return e;
};
var $p = J, wp = Wu, $s = Mi, Cp = Ri, Ap = Tu, Pp = Er, Rp = Pi, ws = ">", Cs = "<", oi = "prototype", ui = "script", qu = Rp("IE_PROTO"), wa = function() {
}, Qu = function(a) {
  return Cs + ui + ws + a + Cs + "/" + ui + ws;
}, As = function(a) {
  a.write(Qu("")), a.close();
  var e = a.parentWindow.Object;
  return a = null, e;
}, Np = function() {
  var a = Pp("iframe"), e = "java" + ui + ":", t;
  return a.style.display = "none", Ap.appendChild(a), a.src = String(e), t = a.contentWindow.document, t.open(), t.write(Qu("document.F=Object")), t.close(), t.F;
}, Zt, vr = function() {
  try {
    Zt = new ActiveXObject("htmlfile");
  } catch {
  }
  vr = typeof document < "u" ? document.domain && Zt ? As(Zt) : Np() : As(Zt);
  for (var a = $s.length; a--; ) delete vr[oi][$s[a]];
  return vr();
};
Cp[qu] = !0;
var Hi = Object.create || function(e, t) {
  var r;
  return e !== null ? (wa[oi] = $p(e), r = new wa(), wa[oi] = null, r[qu] = e) : r = vr(), t === void 0 ? r : wp.f(r, t);
}, Ip = D, Mp = _, _p = Mp.RegExp, Vp = Ip(function() {
  var a = _p(".", "s");
  return !(a.dotAll && a.test(`
`) && a.flags === "s");
}), Dp = D, Lp = _, kp = Lp.RegExp, Bp = Dp(function() {
  var a = kp("(?<a>b)", "g");
  return a.exec("b").groups.a !== "b" || "b".replace(a, "$<a>c") !== "bc";
}), et = Y, _r = L, jp = pe, Fp = Yu, Up = Xu, Gp = Ci, zp = Hi, Hp = wr.get, Yp = Vp, Xp = Bp, Wp = Gp("native-string-replace", String.prototype.replace), mr = RegExp.prototype.exec, li = mr, qp = _r("".charAt), Qp = _r("".indexOf), Kp = _r("".replace), Ps = _r("".slice), hi = function() {
  var a = /a/, e = /b*/g;
  return et(mr, a, "a"), et(mr, e, "a"), a.lastIndex !== 0 || e.lastIndex !== 0;
}(), Ku = Up.BROKEN_CARET, vi = /()??/.exec("")[1] !== void 0, Zp = hi || vi || Ku || Yp || Xp, Rs = function(a, e) {
  for (var t = a.groups = zp(null), r = 0; r < e.length; r++) {
    var i = e[r];
    t[i[0]] = a[i[1]];
  }
};
Zp && (li = function(e) {
  var t = this, r = Hp(t), i = jp(e), n = r.raw, o, s, u;
  if (n)
    return n.lastIndex = t.lastIndex, o = et(li, n, i), t.lastIndex = n.lastIndex, o && r.groups && Rs(o, r.groups), o;
  var l = r.groups, h = Ku && t.sticky, f = et(Fp, t), c = t.source, v = 0, g = i;
  if (h) {
    f = Kp(f, "y", ""), Qp(f, "g") === -1 && (f += "g"), g = Ps(i, t.lastIndex);
    var d = t.lastIndex > 0 && qp(i, t.lastIndex - 1);
    t.lastIndex > 0 && (!t.multiline || t.multiline && d !== `
` && d !== "\r" && d !== "\u2028" && d !== "\u2029") && (c = "(?: (?:" + c + "))", g = " " + g, v++), s = new RegExp("^(?:" + c + ")", f);
  }
  vi && (s = new RegExp("^" + c + "$(?!\\s)", f)), hi && (u = t.lastIndex);
  var p = et(mr, h ? s : t, g);
  return h ? p ? (p.input = i, p[0] = Ps(p[0], v), p.index = t.lastIndex, t.lastIndex += p[0].length) : t.lastIndex = 0 : hi && p && (t.lastIndex = t.global ? p.index + p[0].length : u), vi && p && p.length > 1 && et(Wp, p[0], s, function() {
    for (var y = 1; y < arguments.length - 2; y++)
      arguments[y] === void 0 && (p[y] = void 0);
  }), p && l && Rs(p, l), p;
});
var Yi = li, Jp = ee, Ns = Yi;
Jp({ target: "RegExp", proto: !0, forced: /./.exec !== Ns }, {
  exec: Ns
});
var Is = Y, Ms = Ue, ey = Yi, _s = D, Zu = z, ty = At, ry = Zu("species"), Ca = RegExp.prototype, Xi = function(a, e, t, r) {
  var i = Zu(a), n = !_s(function() {
    var l = {};
    return l[i] = function() {
      return 7;
    }, ""[a](l) !== 7;
  ...
  if (!n || !o || t) {
    var s = /./[i], u = e(i, ""[a], function(l, h, f, c, v) {
      var g = h.exec;
      return g === ey || g === Ca.exec ? n && !v ? { done: !0, value: Is(s, h, f, c) } : { done: !0, value: Is(l, f, h, c) } : { done: !1 };
    });
    Ms(String.prototype, a, u[0]), Ms(Ca, i, u[1]);
  }
  r && ty(Ca[i], "sham", !0);
}, Wi = L, ay = Cr, iy = pe, ny = ve, sy = Wi("".charAt), Vs = Wi("".charCodeAt), oy = Wi("".slice), uy = function(a) {
  return function(e, t) {
    var r = iy(ny(e)), i = ay(t), n = r.length, o, s;
    return i < 0 || i >= n ? a ? "" : void 0 : (o = Vs(r, i), o < 55296 || o > 56319 || i + 1 === n || (s = Vs(r, i + 1)) < 56320 || s > 57343 ? a ? sy(r, i) : o : a ? oy(r, i, i + 2) : (o - 55296 << 10) + (s - 56320) + 65536);
  };
}, ly = {
...
}, vy = _, fy = D, Ds = vy.RegExp, cy = !fy(function() {
  var a = !0;
  try {
    Ds(".", "d");
  } catch {
  ...
  var s = Object.getOwnPropertyDescriptor(Ds.prototype, "flags").get.call(e);
  return s !== r || t !== r;
}), gy = { correct: cy }, dy = Y, py = fe, yy = Tr, Ls = gy, my = Yu, by = RegExp.prototype, Vr = Ls.correct ? function(a) {
  return a.flags;
} : function(a) {
  return !Ls.correct && yy(by, a) && !py(a, "flags") ? dy(my, a) : a.flags;
}, ks = Y, xy = J, Ty = k, Oy = Ce, Sy = Yi, Ey = TypeError, Qi = function(a, e) {
  var t = a.exec;
  if (Ty(t)) {
    var r = ks(t, a, e);
    return r !== null && xy(r), r;
  }
  if (Oy(a) === "RegExp") return ks(Sy, a, e);
  throw new Ey("RegExp#exec called on incompatible receiver");
}, $y = Y, wy = L, Cy = Xi, Ay = J, Py = ae, Ry = ut, Jt = pe, Ny = ve, Iy = ot, My = qi, _y = Vr, Bs = Qi, Aa = wy("".indexOf);
Cy("match", function(a, e, t) {
  return [
    ...
    function(r) {
      ...
      var s = Jt(_y(i));
      if (!~Aa(s, "g")) return Bs(i, n);
      var u = !!~Aa(s, "u") || !!~Aa(s, "v");
      i.lastIndex = 0;
      for (var l = [], h = 0, f; (f = Bs(i, n)) !== null; ) {
        var c = Jt(f[0]);
...
var Ki = L, Vy = Sr, Dy = Math.floor, Pa = Ki("".charAt), Ly = Ki("".replace), Ra = Ki("".slice), ky = /\$([$&'`]|\d{1,2}|<[^>]*>)/g, By = /\$([$&'`]|\d{1,2})/g, jy = function(a, e, t, r, i, n) {
...
}, Fy = xu, js = Y, Dr = L, Uy = Xi, Gy = D, zy = J, Hy = k, Yy = ae, Xy = Cr, Wy = ut, _e = pe, qy = ve, Qy = qi, Ky = ot, Zy = jy, Jy = Vr, em = Qi, tm = z, fi = tm("replace"), rm = Math.max, am = Math.min, im = Dr([].concat), Na = Dr([].push), We = Dr("".indexOf), Fs = Dr("".slice), nm = function(a) {
...
Uy("replace", function(a, e, t) {
  ...
  return [
    ...
    function(n, o) {
      var s = qy(this), u = Yy(n) ? Ky(n, fi) : void 0;
      return u ? js(u, n, s, o) : js(e, _e(s), n, o);
    },
    // `RegExp.prototype[@@replace]` method
    // https://tc39.es/ecma262/#sec-regexp.prototype-@@replace
    function(i, n) {
      var o = zy(this), s = _e(i), u = Hy(n);
      u || (n = _e(n));
      var l = _e(Jy(o));
      ...
      for (var v = [], g; g = em(o, s), !(g === null || (Na(v, g), !f)); ) {
        var d = _e(g[0]);
        d === "" && (o.lastIndex = Qy(s, Wy(o.lastIndex), c));
      }
      for (var p = "", y = 0, T = 0; T < v.length; T++) {
        g = v[T];
        for (var b = _e(g[0]), x = rm(am(Xy(g.index), s.length), 0), $ = [], E, O = 1; O < g.length; O++) Na($, nm(g[O]));
        var C = g.groups;
        if (u) {
          var P = im([b], $, x, s);
          C !== void 0 && Na(P, C), E = _e(Fy(n, void 0, P));
        } else
          E = Zy(b, s, x, $, C, n);
        x >= y && (p += Fs(s, y, x) + E, y = x + b.length);
      }
      return p + Fs(s, y);
    }
  ];
}, !om || !sm || Us);
var um = ae, lm = Ce, hm = z, vm = hm("match"), fm = function(a) {
  var e;
  return um(a) && ((e = a[vm]) !== void 0 ? !!e : lm(a) === "RegExp");
}, cm = fm, gm = TypeError, Zi = function(a) {
  if (cm(a))
    throw new gm("The method doesn't accept regular expressions");
  return a;
}, dm = z, pm = dm("match"), Ji = function(a) {
  var e = /./;
  try {
    "/./"[a](e);
  } catch {
  ...
  return !1;
}, ym = ee, mm = Rr, bm = $t.f, xm = ut, Gs = pe, Tm = Zi, Om = ve, Sm = Ji, Em = mm("".slice), $m = Math.min, Ju = Sm("startsWith"), wm = !Ju && !!function() {
  var a = bm(String.prototype, "startsWith");
  return a && !a.writable;
}();
ym({ target: "String", proto: !0, forced: !wm && !Ju }, {
  startsWith: function(e) {
    var t = Gs(Om(this));
    Tm(e);
    var r = Gs(e), i = xm($m(arguments.length > 1 ? arguments[1] : void 0, t.length));
    return Em(t, i, i + r.length) === r;
  }
});
var Cm = z, Am = Hi, Pm = Te.f, ci = Cm("unscopables"), gi = Array.prototype;
gi[ci] === void 0 && Pm(gi, ci, {
  configurable: !0,
  value: Am(null)
});
var Rm = function(a) {
...
}), Mm = fe, _m = k, Vm = Sr, Dm = Pi, Lm = Im, zs = Dm("IE_PROTO"), di = Object, km = di.prototype, el = Lm ? di.getPrototypeOf : function(a) {
  var e = Vm(a);
  if (Mm(e, zs)) return e[zs];
  var t = e.constructor;
  return _m(t) && e instanceof t ? t.prototype : e instanceof di ? km : null;
}, Bm = D, jm = k, Fm = ae, Hs = el, Um = Ue, Gm = z, pi = Gm("iterator"), tl = !1, Be, Ia, Ma;
[].keys && (Ma = [].keys(), "next" in Ma ? (Ia = Hs(Hs(Ma)), Ia !== Object.prototype && (Be = Ia)) : tl = !0);
var zm = !Fm(Be) || Bm(function() {
  var a = {};
  return Be[pi].call(a) !== a;
});
zm && (Be = {});
jm(Be[pi]) || Um(Be, pi, function() {
  return this;
});
var rl = {
  IteratorPrototype: Be,
  BUGGY_SAFARI_ITERATORS: tl
}, Hm = rl.IteratorPrototype, Ym = Hi, Xm = Si, Wm = Pr, qm = Mr, Qm = function() {
  return this;
}, Km = function(a, e, t, r) {
  var i = e + " Iterator";
  return a.prototype = Ym(Hm, { next: Xm(+!r, t) }), Wm(a, i, !1), qm[i] = Qm, a;
}, Zm = ee, Jm = Y, al = $r, e0 = k, t0 = Km, Ys = el, Xs = vu, r0 = Pr, a0 = At, _a = Ue, i0 = z, n0 = Mr, il = rl, s0 = al.PROPER, o0 = al.CONFIGURABLE, Ws = il.IteratorPrototype, er = il.BUGGY_SAFARI_ITERATORS, gt = i0("iterator"), qs = "keys", dt = "values", Qs = "entries", u0 = function() {
  return this;
  ...
  if (v && (g = Ys(v.call(new a())), g !== Object.prototype && g.next && (Ys(g) !== Ws && (Xs ? Xs(g, Ws) : e0(g[gt]) || _a(g, gt, u0)), r0(g, u, !0))), s0 && i === dt && f && f.name !== dt && (o0 ? a0(h, "name", dt) : (l = !0, c = function() {
    return Jm(f, this);
  })), i)
    if (d = {
      values: s(dt),
    ...
    else Zm({ target: e, proto: !0, forced: er || l }, d);
  return h[gt] !== c && _a(h, gt, c, { name: i }), n0[e] = c, d;
}, h0 = function(a, e) {
  return { value: a, done: e };
}, v0 = wt, en = Rm, Ks = Mr, nl = wr, f0 = Te.f, c0 = l0, tr = h0, g0 = he, sl = "Array Iterator", d0 = nl.set, p0 = nl.getterFor(sl), y0 = c0(Array, "Array", function(a, e) {
  d0(this, {
    type: sl,
    target: v0(a),
    // target
  ...
  return tr([t, e[t]], !1);
}, "values"), Zs = Ks.Arguments = Ks.Array;
en("keys");
en("values");
en("entries");
if (g0 && Zs.name !== "values") try {
  f0(Zs, "name", { value: "values" });
} catch {
}
var m0 = {
  CSSRuleList: 0,
  ...
  TextTrackList: 0,
  TouchList: 0
}, b0 = Er, Va = b0("span").classList, Js = Va && Va.constructor && Va.constructor.prototype, x0 = Js === Object.prototype ? void 0 : Js, eo = _, ol = m0, T0 = x0, yt = y0, to = At, O0 = Pr, S0 = z, Da = S0("iterator"), La = yt.values, ul = function(a, e) {
  if (a) {
    if (a[Da] !== La) try {
      to(a, Da, La);
    } catch {
...
for (var ka in ol)
  ul(eo[ka] && eo[ka].prototype, ka);
ul(T0, "DOMTokenList");
function E0(a, e) {
  if (Xa(a) != "object" || !a) return a;
...
var w0 = Ae, C0 = Sr, A0 = Go, P0 = Ii, ro = TypeError, ao = "Reduce of empty array with no initial value", R0 = function(a) {
  return function(e, t, r, i) {
    var n = C0(e), o = A0(n), s = P0(n);
    if (w0(t), s === 0 && r < 2) throw new ro(ao);
  ...
  left: R0(!1)
}, I0 = D, ll = function(a, e) {
  var t = [][a];
  return !!t && I0(function() {
    t.call(null, e || function() {
      return 1;
    }, 1);
  });
}, M0 = ee, _0 = N0.left, V0 = ll, io = Ei, D0 = Ar, L0 = !D0 && io > 79 && io < 83, k0 = L0 || !V0("reduce");
M0({ target: "Array", proto: !0, forced: k0 }, {
  reduce: function(e) {
    var t = arguments.length;
    return _0(this, e, t, t > 1 ? arguments[1] : void 0);
  }
});
var B0 = ee, j0 = Rr, F0 = $t.f, U0 = ut, no = pe, G0 = Zi, z0 = ve, H0 = Ji, Y0 = j0("".slice), X0 = Math.min, hl = H0("endsWith"), W0 = !hl && !!function() {
  var a = F0(String.prototype, "endsWith");
  return a && !a.writable;
}();
B0({ target: "String", proto: !0, forced: !W0 && !hl }, {
  endsWith: function(e) {
    var t = no(z0(this));
    G0(e);
    var r = no(e), i = arguments.length > 1 ? arguments[1] : void 0, n = t.length, o = i === void 0 ? n : X0(U0(i), n);
    return Y0(t, o - r.length, o) === r;
  }
});
var Ba = Y, rn = L, q0 = Xi, Q0 = J, K0 = ae, Z0 = ve, J0 = mu, eb = qi, tb = ut, ja = pe, rb = ot, ab = Vr, so = Qi, ib = Xu, nb = D, qe = ib.UNSUPPORTED_Y, sb = 4294967295, ob = Math.min, Fa = rn([].push), Ua = rn("".slice), rr = rn("".indexOf), ub = !nb(function() {
  var a = /(?:)/, e = a.exec;
  a.exec = function() {
...
}), oo = "abbc".split(/(b)*/)[1] === "c" || // eslint-disable-next-line regexp/no-empty-group -- required for testing
...
q0("split", function(a, e, t) {
  ...
  return [
    ...
    function(n, o) {
      var s = Z0(this), u = K0(n) ? rb(n, a) : void 0;
    ...
    // the 'y' flag.
    function(i, n) {
      var o = Q0(this), s = ja(i);
      if (!oo) {
        var u = t(r, o, s, n, r !== e);
        if (u.done) return u.value;
      }
      var l = J0(o, RegExp), h = ja(ab(o)), f = !!~rr(h, "u") || !!~rr(h, "v");
      qe ? ~rr(h, "g") || (h += "g") : ~rr(h, "y") || (h += "y");
      var c = new l(qe ? "^(?:" + o.source + ")" : o, h), v = n === void 0 ? sb : n >>> 0;
      if (v === 0) return [];
      if (s.length === 0) return so(c, s) === null ? [s] : [];
      for (var g = 0, d = 0, p = []; d < s.length; ) {
        c.lastIndex = qe ? 0 : d;
        var y = so(c, qe ? Ua(s, d) : s), T;
        if (y === null || (T = ob(tb(c.lastIndex + (qe ? d : 0)), s.length)) === g)
          d = eb(s, d, f);
        else {
          if (Fa(p, Ua(s, g, d)), p.length === v) return p;
          for (var b = 1; b <= y.length - 1; b++)
            if (Fa(p, y[b]), p.length === v) return p;
          d = g = T;
        }
      }
...
var lb = mt.exports, hb = lb, be = typeof window > "u" ? Ke : window, ar = ["moz", "webkit"], rt = "AnimationFrame", st = be["request" + rt], Et = be["cancel" + rt] || be["cancelRequest" + rt];
for (var pt = 0; !st && pt < ar.length; pt++)
  st = be[ar[pt] + "Request" + rt], Et = be[ar[pt] + "Cancel" + rt] || be[ar[pt] + "CancelRequest" + rt];
if (!st || !Et) {
  var Ga = 0, uo = 0, Ve = [], vb = 1e3 / 60;
  st = function(a) {
    if (Ve.length === 0) {
      var e = hb(), t = Math.max(0, vb - (e - Ga));
...
var fb = Lr.exports;
const za = /* @__PURE__ */ Do(fb);
var vl = `	
\v\f\r                　\u2028\u2029\uFEFF`, cb = L, gb = ve, db = pe, yi = vl, lo = cb("".replace), pb = RegExp("^[" + yi + "]+"), yb = RegExp("(^|[^" + yi + "])[" + yi + "]+$"), mb = function(a) {
  return function(e) {
    var t = db(gb(e));
    return a & 1 && (t = lo(t, pb, "")), a & 2 && (t = lo(t, yb, "$1")), t;
  };
}, bb = {
  // `String.prototype.trim` method
  // https://tc39.es/ecma262/#sec-string.prototype.trim
  trim: mb(3)
}, xb = $r.PROPER, Tb = D, ho = vl, vo = "​᠎", Ob = function(a) {
  return Tb(function() {
    return !!ho[a]() || vo[a]() !== vo || xb && ho[a].name !== a;
  });
...
const mi = /* @__PURE__ */ Do(wb);
var Cb = ee, Ab = Rr, Pb = su.indexOf, Rb = ll, bi = Ab([].indexOf), fl = !!bi && 1 / bi([1], 1, -0) < 0, Nb = fl || !Rb("indexOf");
Cb({ target: "Array", proto: !0, forced: Nb }, {
  indexOf: function(e) {
    var t = arguments.length > 1 ? arguments[1] : void 0;
    return fl ? bi(this, e, t) || 0 : Pb(this, e, t);
  }
});
var Ib = ee, Mb = L, _b = Zi, Vb = ve, fo = pe, Db = Ji, Lb = Mb("".indexOf);
...
var kb = Ce, Bb = Array.isArray || function(e) {
  return kb(e) === "Array";
}, jb = ee, Fb = L, Ub = Bb, Gb = Fb([].reverse), co = [1, 2];
jb({ target: "Array", proto: !0, forced: String(co) === String(co.reverse()) }, {
  reverse: function() {
...
function Ha(a, e, t) {
  ...
  var s = xi([(e - n) / 2, (t - o) / 2], -a.xRot / 180 * Se), u = s[0], l = s[1], h = Math.pow(u, 2) / Math.pow(r, 2) + Math.pow(l, 2) / Math.pow(i, 2);
  1 < h && (r *= Math.sqrt(h), i *= Math.sqrt(h)), a.rX = r, a.rY = i;
  var f = Math.pow(r, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2), c = (a.lArcFlag !== a.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(r, 2) * Math.pow(i, 2) - f) / f)), v = r * l / i * c, g = -i * u / r * c, d = xi([v, g], a.xRot / 180 * Se);
...
(function(a) {
  ...
  a.ROUND = function(s) {
    ...
    return i(function(s, u, l) {
      return m.ARC === s.type ? function(h, f, c) {
        ...
        for (var y = Math.min(h.phi1, h.phi2), T = Math.max(h.phi1, h.phi2) - y, b = Math.ceil(T / 90), x = new Array(b), $ = f, E = c, O = 0; O < b; O++) {
          var C = po(h.phi1, h.phi2, O / b), P = po(h.phi1, h.phi2, (O + 1) / b), V = P - C, j = 4 / 3 * Math.tan(V * ye / 4), R = [Math.cos(C * ye) - j * Math.sin(C * ye), Math.sin(C * ye) + j * Math.cos(C * ye)], X = R[0], W = R[1], G = [Math.cos(P * ye), Math.sin(P * ye)], q = G[0], H = G[1], Q = [q + j * Math.sin(P * ye), H - j * Math.cos(P * ye)], N = Q[0], M = Q[1];
          x[O] = { relative: h.relative, type: m.CURVE_TO };
          var K = function(se, ge) {
            var Oe = xi([se * h.rX, ge * h.rY], h.xRot), ze = Oe[0], It = Oe[1];
    ...
    return i(function(s, u, l) {
      return s.relative && (u = 0, l = 0), m.ARC === s.type && Ha(s, u, l), s;
    });
    ...
    var s = function(c) {
      ...
      if (d.type & m.DRAWING_COMMANDS && (p(v), y(g)), d.type & m.HORIZ_LINE_TO && p(d.x), d.type & m.VERT_LINE_TO && y(d.y), d.type & m.LINE_TO && (p(d.x), y(d.y)), d.type & m.CURVE_TO) {
        p(d.x), y(d.y);
        for (var T = 0, b = mo(v, d.x1, d.x2, d.x); T < b.length; T++)
          0 < (N = b[T]) && 1 > N && p(bo(v, d.x1, d.x2, d.x, N));
        for (var x = 0, $ = mo(g, d.y1, d.y2, d.y); x < $.length; x++)
          0 < (N = $[x]) && 1 > N && y(bo(g, d.y1, d.y2, d.y, N));
      }
      if (d.type & m.ARC) {
        p(d.x), y(d.y), Ha(d, v, g);
        ...
        }, G = 0, q = go(P, -O, 0).map(W); G < q.length; G++)
          (N = q[G]) > R && N < X && p(yo(d.cX, O, P, N));
        for (var H = 0, Q = go(V, -C, 0).map(W); H < Q.length; H++) {
          var N;
          (N = Q[H]) > R && N < X && y(yo(d.cY, C, V, N));
        }
      }
      return c;
    });
...
`;
  ...
  return gl(e, a), e.prototype.finish = function(t) {
    ...
    for (var n = function(f) {
      ...
      if (!xo(s) || l) if (s !== "e" && s !== "E") if (s !== "-" && s !== "+" || !this.curNumberHasExp || this.curNumberHasExpDigits) if (s !== "." || this.curNumberHasExp || this.curNumberHasDecimal || u) {
        ...
        if (!Hb(s)) if (s === "," && this.canParseCommandOrComma) this.canParseCommandOrComma = !1;
...
}(dl), Xb = ((oe = {})[m.MOVE_TO] = 2, oe[m.LINE_TO] = 2, oe[m.HORIZ_LINE_TO] = 1, oe[m.VERT_LINE_TO] = 1, oe[m.CLOSE_PATH] = 0, oe[m.QUAD_TO] = 4, oe[m.SMOOTH_QUAD_TO] = 2, oe[m.CURVE_TO] = 6, oe[m.SMOOTH_CURVE_TO] = 4, oe[m.ARC] = 7, oe), Wb = $r.PROPER, qb = Ue, Qb = J, To = pe, Kb = D, Zb = Vr, an = "toString", pl = RegExp.prototype, yl = pl[an], Jb = Kb(function() {
  return yl.call({ source: "a", flags: "b" }) !== "/a/b";
}), e1 = Wb && yl.name !== an;
(Jb || e1) && qb(pl, an, function() {
  var e = Qb(this), t = To(e.source), r = To(Zb(e));
  return "/" + t + "/" + r;
}, { unsafe: !0 });
function fr(a) {
...
function s1(a, e, t, r, i, n) {
  for (var o = a.data, s = 2 * n + 1, u = r - 1, l = i - 1, h = n + 1, f = h * (h + 1) / 2, c = new Oo(), v = c, g, d = 1; d < s; d++)
    v = v.next = new Oo(), d === h && (g = v);
  v.next = c;
  for (var p = null, y = null, T = 0, b = 0, x = r1[n], $ = a1[n], E = 0; E < i; E++) {
    ...
    for (var R = 0, X = 0, W = 0, G = 0, q = h * O, H = h * C, Q = h * P, N = h * V, M = f * O, K = f * C, se = f * P, ge = f * V, Oe = 1; Oe < h; Oe++) {
      var ze = b + ((u < Oe ? u : Oe) << 2), It = o[ze], on = o[ze + 1], un = o[ze + 2], ln = o[ze + 3], Mt = h - Oe;
      M += (v.r = It) * Mt, K += (v.g = on) * Mt, se += (v.b = un) * Mt, ge += (v.a = ln) * Mt, R += It, X += on, W += un, G += ln, v = v.next;
    }
    p = c, y = g;
    for (var Ur = 0; Ur < r; Ur++) {
      ...
      var _t = y, hn = _t.r, vn = _t.g, fn = _t.b, cn = _t.a;
      q += hn, H += vn, Q += fn, N += cn, R -= hn, X -= vn, W -= fn, G -= cn, y = y.next, b += 4;
    }
    T += r;
  }
  for (var He = 0; He < r; He++) {
    ...
    for (var dn = r, qr = 0, Qr = 0, Kr = 0, Zr = 0, Bt = 1; Bt <= n; Bt++) {
      b = dn + He << 2;
      var jt = h - Bt;
      Vt += (v.r = Re = o[b]) * jt, Dt += (v.g = Ne = o[b + 1]) * jt, Lt += (v.b = Ie = o[b + 2]) * jt, kt += (v.a = te = o[b + 3]) * jt, Zr += Re, qr += Ne, Qr += Ie, Kr += te, v = v.next, Bt < l && (dn += r);
    }
    b = He, p = c, y = g;
...
function T1(a) {
  ...
  return [t, r] = De(t, g1), e[1] += r, [t, r] = De(t, d1), e[0] += r, [t, r] = De(t, p1), e[1] += r, [t, r] = De(t, y1), e[2] += r, [t, r] = De(t, m1), e[1] += r, [t, r] = De(t, b1), e[1] += r, t = t.replace(/[*\s+>~]/g, " ").replace(/[#.]/g, " "), [t, r] = De(t, x1), e[2] += r, e.join("");
}
var at = 1e-8;
function So(a) {
...
var {
  defaultFetch: E1
} = kr, $1 = typeof DOMParser < "u" ? DOMParser : null;
class Ya {
  constructor() {
    var {
      fetch: e = E1,
...
class je {
  constructor(e, t, r) {
    ...
    i.forEach((n) => {
      if (n !== "none") {
        var [o, s] = I1(n), u = je.transformTypes[o];
...
function V1(a) {
  return typeof process > "u" ? a : a.trim().split(",").map(_1).join(",");
}
function D1(a) {
  if (!a)
    return "";
...
class A extends Ge {
  ...
  static pathA(e) {
    ...
    isNaN(v) && (v = 0);
    var g = new B(v * i * f.y / n, v * -n * f.x / i), d = new B((t.x + h.x) / 2 + Math.cos(l) * g.x - Math.sin(l) * g.y, (t.y + h.y) / 2 + Math.sin(l) * g.x + Math.cos(l) * g.y), p = Eo([1, 0], [(f.x - g.x) / i, (f.y - g.y) / n]), y = [(f.x - g.x) / i, (f.y - g.y) / n], T = [(-f.x - g.x) / i, (-f.y - g.y) / n], b = Eo(y, T);
    return Ti(y, T) <= -1 && (b = Math.PI), Ti(y, T) >= 1 && (b = 0), {
      currentPoint: h,
      rX: i,
      rY: n,
      sweepFlag: u,
...
class r2 extends we {
  ...
  getPointOnQuadraticBezier(e, t, r, i, n, o, s) {
    var u = o * Po(e) + i * Ro(e) + t * No(e), l = s * Po(e) + n * Ro(e) + r * No(e);
    return {
      x: u,
      y: l
    };
...
class Ee {
  ...
  createElement(e) {
    ...
    return typeof r < "u" ? new r(this, e) : new M1(this, e);
  }
  createTextNode(e) {
...
class bt {
  ...
  constructor(e, t) {
    ...
    this.parser = new Ya(r), this.screen = new kr(e, r), this.options = r;
  ...
  static from(e, t) {
    var r = arguments;
    return xe(function* () {
      var i = r.length > 2 && r[2] !== void 0 ? r[2] : {}, n = new Ya(i), o = yield n.parse(t);
      return new bt(e, o, i);
    })();
  }
  /**
  ...
  static fromString(e, t) {
    var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, i = new Ya(r), n = i.parseFromString(t);
    return new bt(e, n, r);
  }
  /**
