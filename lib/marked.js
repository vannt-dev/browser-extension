...
var xe = (a, t, e) => t in a ? de(a, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[t] = e;
var d = (a, t, e) => xe(a, typeof t != "symbol" ? t + "" : t, e), be = (a, t, e) => t.has(a) || V("Cannot " + e);
var Y = (a, t, e) => t.has(a) ? V("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(a) : t.set(a, e);
var C = (a, t, e) => (be(a, t, "access private method"), e);
function j() {
  return {
    async: !1,
    breaks: !1,
...
const le = /[&<>"']/, me = new RegExp(le.source, "g"), oe = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, we = new RegExp(oe.source, "g"), ye = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
  '"': "&quot;",
...
function Te(a) {
  return a.replace($e, (t, e) => (e = e.toLowerCase(), e === "colon" ? ":" : e.charAt(0) === "#" ? e.charAt(1) === "x" ? String.fromCharCode(parseInt(e.substring(2), 16)) : String.fromCharCode(+e.substring(1)) : ""));
}
const ze = /(^|[^\[])\^/g;
function k(a, t) {
  ...
  const n = {
    replace: (i, r) => {
      ...
      return s = s.replace(ze, "$1"), e = e.replace(i, s), n;
    },
...
function se(a, t, e, n) {
  const i = t.href, r = t.title ? x(t.title) : null, s = a[1].replace(/\\([\[\]])/g, "$1");
  if (a[0].charAt(0) !== "!") {
    n.state.inLink = !0;
    const l = {
      type: "link",
...
`, t = t.substring(h.length + 1), c = !0), !c) {
          const Q = new RegExp(`^ {0,${Math.min(3, g - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), W = new RegExp(`^ {0,${Math.min(3, g - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), J = new RegExp(`^ {0,${Math.min(3, g - 1)}}(?:\`\`\`|~~~)`), K = new RegExp(`^ {0,${Math.min(3, g - 1)}}#`);
          for (; t; ) {
            const M = t.split(`
`, 1)[0];
            if (h = M, this.options.pedantic && (h = h.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")), J.test(h) || K.test(h) || Q.test(h) || W.test(t))
              break;
            if (h.search(/[^ ]/) >= g || !h.trim())
              o += `
` + h.slice(g);
            else {
              if (y || u.search(/[^ ]/) >= 4 || J.test(u) || K.test(u) || W.test(u))
                break;
              o += `
` + h;
            }
            !y && !h.trim() && (y = !0), l += M + `
`, t = t.substring(M.length + 1), u = h.slice(g);
          }
        }
        r.loose || (p ? r.loose = !0 : /\n *\n *$/.test(l) && (p = !0));
        let b = null, $;
        this.options.gfm && (b = /^\[[ xX]\] /.exec(o), b && ($ = b[0] !== "[ ] ", o = o.replace(/^\[[ xX]\] +/, ""))), r.items.push({
          type: "list_item",
          raw: l,
          task: !!b,
          checked: $,
      ...
      for (let c = 0; c < r.items.length; c++)
        if (this.lexer.state.top = !1, r.items[c].tokens = this.lexer.blockTokens(r.items[c].text, []), !r.loose) {
          const u = r.items[c].tokens.filter((g) => g.type === "space"), h = u.length > 0 && u.some((g) => /\n.*\n/.test(g.raw));
          r.loose = h;
        }
      if (r.loose)
        for (let c = 0; c < r.items.length; c++)
  ...
  table(t) {
    ...
    if (!e || !/[:|]/.test(e[2]))
      return;
    const n = ne(e[1]), i = e[2].replace(/^\||\| *$/g, "").split("|"), r = e[3] && e[3].trim() ? e[3].replace(/\n[ \t]*$/, "").split(`
`) : [], s = {
      type: "table",
      raw: e[0],
      header: [],
...
` ? e[1].slice(0, -1) : e[1];
  ...
  link(t) {
    ...
    if (e) {
      ...
      if (this.options.pedantic) {
        ...
        r = e[3] ? e[3].slice(1, -1) : "";
      return i = i.trim(), /^</.test(i) && (this.options.pedantic && !/>$/.test(n) ? i = i.slice(1) : i = i.slice(1, -1)), se(e, {
    ...
    if (!(i[1] || i[2] || "") || !n || this.rules.inline.punctuation.exec(n)) {
      ...
      for (u.lastIndex = 0, e = e.slice(-1 * t.length + s); (i = u.exec(e)) != null; ) {
        ...
        if (p -= o, p > 0)
          continue;
        o = Math.min(o, o + p + c);
        const h = [...i[0]][0].length, g = t.slice(0, s + i.index + h + o);
        if (Math.min(s, o) % 2) {
          const b = g.slice(1, -1);
          return {
            type: "em",
  ...
  autolink(t) {
    ...
    if (e) {
      let n, i;
      return e[2] === "@" ? (n = x(e[1]), i = "mailto:" + n) : (n = x(e[1]), i = n), {
        type: "link",
        raw: e[0],
        text: n,
        href: i,
  ...
  url(t) {
    ...
    if (e = this.rules.inline.url.exec(t)) {
      ...
      if (e[2] === "@")
        ...
        while (s !== e[0]);
        i = x(e[0]), e[1] === "www." ? r = "http://" + e[0] : r = e[0];
      }
      return {
        type: "link",
        raw: e[0],
  ...
  inlineText(t) {
    ...
    if (e) {
      let n;
      return this.lexer.state.inRawBlock ? n = e[0] : n = x(e[0]), {
        type: "text",
        raw: e[0],
        text: n
      };
...
const Ie = /^(?: *(?:\n|$))+/, Se = /^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/, Ae = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, A = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, Ee = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, ae = /(?:[*+-]|\d{1,9}[.)])/, ce = k(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g, ae).replace(/blockCode/g, / {4}/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).getRegex(), H = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, Ce = /^[^\n]+/, N = /(?!\s*\])(?:\\.|[^\[\]\\])+/, Le = k(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace("label", N).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), qe = k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, ae).getRegex(), v = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", F = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, Pe = k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))", "i").replace("comment", F).replace("tag", v).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), he = k(H).replace("hr", A).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v).getRegex(), Ze = k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", he).getRegex(), U = {
  ...
  ...U,
  table: ie,
  paragraph: k(H).replace("hr", A).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", ie).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v).getRegex()
}, ve = {
  ...U,
  ...
  ...X,
  link: k(/^!?\[(label)\]\((.*?)\)/).replace("label", Z).getRegex(),
  reflink: k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Z).getRegex()
}, D = {
  ...X,
...
class m {
  constructor(t) {
    ...
    d(this, "tokenizer");
    d(this, "inlineQueue");
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = t || R, this.options.tokenizer = this.options.tokenizer || new P(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
      inLink: !1,
      inRawBlock: !1,
      top: !0
    };
    ...
    this.options.pedantic ? (e.block = q.pedantic, e.inline = _.pedantic) : this.options.gfm && (e.block = q.gfm, this.options.breaks ? e.inline = _.breaks : e.inline = _.gfm), this.tokenizer.rules = e;
  }
  /**
   * Expose Rules
   */
   ...
   */
  static lex(t, e) {
    return new m(e).lex(t);
  }
  /**
   * Static Lex Inline Method
   */
  static lexInline(t, e) {
    return new m(e).inlineTokens(t);
  }
  /**
   * Preprocessing
   */
...
class w {
  constructor(t) {
    ...
    d(this, "renderer");
    d(this, "textRenderer");
    this.options = t || R, this.options.renderer = this.options.renderer || new B(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new G();
  }
  /**
   * Static Parse Method
   */
  static parse(t, e) {
    return new w(e).parse(t);
  }
  /**
   * Static Parse Inline Method
   */
  static parseInline(t, e) {
    return new w(e).parseInline(t);
  }
  /**
   * Parse Loop
   */
      ...
      switch (r.type) {
        ...
        case "list": {
          ...
          for (let u = 0; u < s.items.length; u++) {
            const h = s.items[u], g = h.checked, y = h.task;
            let b = "";
            if (h.task) {
              const $ = this.renderer.checkbox(!!g);
              p ? h.tokens.length > 0 && h.tokens[0].type === "paragraph" ? (h.tokens[0].text = $ + " " + h.tokens[0].text, h.tokens[0].tokens && h.tokens[0].tokens.length > 0 && h.tokens[0].tokens[0].type === "text" && (h.tokens[0].tokens[0].text = $ + " " + h.tokens[0].tokens[0].text)) : h.tokens.unshift({
                type: "text",
                text: $ + " "
              }) : b += $ + " ";
            }
            b += this.parse(h.tokens, p), c += this.renderer.listitem(b, y, !!g);
          }
...
d(S, "passThroughHooks", /* @__PURE__ */ new Set([
  "preprocess",
  "postprocess",
  "processAllTokens"
]));
...
class Ye {
  constructor(...t) {
    ...
    d(this, "parse", C(this, z, O).call(this, m.lex, w.parse));
    d(this, "parseInline", C(this, z, O).call(this, m.lexInline, w.parseInline));
    d(this, "Parser", w);
    d(this, "Renderer", B);
    d(this, "TextRenderer", G);
    d(this, "Lexer", m);
    d(this, "Tokenizer", P);
    d(this, "Hooks", S);
    this.use(...t);
    ...
    return t.forEach((n) => {
      ...
      if (n.hooks) {
        ...
        for (const s in n.hooks) {
          ...
          S.passThroughHooks.has(s) ? r[l] = (c) => {
...
z = new WeakSet(), O = function(t, e) {
  return (n, i) => {
    ...
    const l = C(this, z, ke).call(this, !!s.silent, !!s.async);
...
f.options = f.setOptions = function(a) {
  return T.setOptions(a), f.defaults = T.defaults, re(f.defaults), f;
};
f.getDefaults = j;
f.defaults = R;
f.use = function(...a) {
  return T.use(...a), f.defaults = T.defaults, re(f.defaults), f;
};
f.walkTokens = function(a, t) {
  return T.walkTokens(a, t);
};
...
f.Hooks = S;
f.parse = f;
const tt = f.options, nt = f.setOptions, st = f.use, it = f.walkTokens, rt = f.parseInline, lt = f, ot = w.parse, at = m.lex;
export {
  S as Hooks,
  m as Lexer,
  Ye as Marked,
